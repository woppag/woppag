...
const I18N = {
  ...
  translations: {
    ...
    meta_title: {
      ...
      ar: 'WOPPAG KRAFT & FOODS — مصنع التعبئة والتغليف بالجملة | توريد مباشر من المصنع B2B'
    },
    meta_description: {
      en: 'WOPPAG KRAFT & FOODS — Direct factory wholesale packaging manufacturer. Kraft bags, biodegradable pouches, napkins, perfume bottles, HoReCa & hotel amenities. OEM custom branding. Exporting to 50+ countries.',
      ru: 'WOPPAG KRAFT & FOODS — Производитель упаковки напрямую с завода. Крафт пакеты, биоразлагаемые дойпаки, салфетки, отельный текстиль. OEM логотип. Экспорт в 50+ стран.',
      ro: 'WOPPAG KRAFT & FOODS — Producător direct de ambalaje angro. Pungi kraft, doypack biodegradabile, șervețele, consumabile hotel. Branding OEM. Export în 50+ țări.',
      de: 'WOPPAG KRAFT & FOODS — Direkt vom Werk hergestellte Verpackungen. Kraftpapiertaschen, biologisch abbaubare Beutel, Servietten, Hotelbedarf. OEM Branding. Export in 50+ Länder.',
      fr: 'WOPPAG KRAFT & FOODS — Fabricant d’emballages en gros direct usine. Sacs kraft, sachets biodégradables, serviettes, fournitures d’hôtel. Marque OEM. Export vers 50+ pays.',
      ar: 'WOPPAG KRAFT & FOODS — المصنع المباشر لتصنيع مواد التعبئة والتغليف بالجملة. أكياس الكرافت، عبوات صديقة للبيئة، مناديل معطرة، ومستلزمات الفنادق. طباعة الشعارات والتصدير لأكثر من 50 دولة.'
    },
    ...
    hero_visual_3_desc: { en: 'Full container load (FCL) and pallet shipping handling to 50+ countries.', ru: 'Доставка контейнерами (FCL) и паллетами в 50+ стран мира.', ro: 'Livrare containere FCL și paleți în peste 50 de țări.', de: 'Container- (FCL) und Palettenversand in über 50 Länder.', fr: 'Expédition par conteneurs complets (FCL) et palettes vers 50+ pays.', ar: 'شحن الحاويات الكاملة (FCL) والباليتات لأكثر من 50 دولة.' },
    ...
    stat_countries_num: { en: '50+', ru: '50+', ro: '50+', de: '50+', fr: '50+', ar: '+٥٠' },
    stat_countries_lbl: { en: 'Export Countries', ru: 'Стран экспорта', ro: 'Țări de export', de: 'Exportländer', fr: 'Pays d’exportation', ar: 'دولة يتم التصدير إليها' },
    stat_units_num: { en: '500M+', ru: '500М+', ro: '500M+', de: '500M+', fr: '500M+', ar: '+٥٠٠M' },
    stat_units_lbl: { en: 'Units Produced Yearly', ru: 'Единиц в год', ro: 'Unități produse anual', de: 'Einheiten pro Jahr', fr: 'Unités produites par an', ar: 'وحدة يتم إنتاجها سنوياً' },
    ...
    why_3_title: { en: 'Eco & Food Grade Certified', ru: 'Пищевые и эко-сертификаты', ro: 'Certificări eco & alimentare', de: 'Eco & Lebensmittel-Zertifiziert', fr: 'Certifié Alimentaire & Éco', ar: 'شهادات الجودة الغذائية والبيئية' },
    why_3_desc: { en: 'ISO 22000, HACCP, Halal, TÜV Austria OK Compost, and FSC certified materials.', ru: 'Сертификаты ISO 22000, HACCP, Халяль, TÜV Austria OK Compost и FSC.', ro: 'Materiale certificate ISO 22000, HACCP, Halal, TÜV Austria și FSC.', de: 'Zertifizierte Materialien nach ISO 22000, HACCP, Halal, TÜV Austria und FSC.', fr: 'Matériaux certifiés ISO 22000, HACCP, Halal, TÜV Austria et FSC.', ar: 'مواد معتمدة بشهادات ISO 22000 و HACCP وحلال و TÜV Austria و FSC.' },
