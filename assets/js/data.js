...
const CATS = [
  {
    ...
    group: 'packaging',
    icon: '🧂',
    img: './assets/images/products/cleaning/product_116.jpeg',
    chip: {
    ...
    products: [
      { icon: '🧂', img: './assets/images/products/cleaning/product_117.jpeg', name: { en: 'Portion Salt & Black Pepper Sachets', ru: 'Порционная соль и черный перец в саше', ro: 'Sare și piper negru porționat la plic', de: 'Portionssalz & Schwarzer Pfeffer', fr: 'Sel & Poivre noir en sachet portion', ar: 'ملح وفلفل أسود في عبوات فردية' } },
      { icon: '🍬', img: './assets/images/products/cleaning/product_118.png', name: { en: 'Portion White Sugar Sticks 4g', ru: 'Сахарные стики с логотипом 4г', ro: 'Plicuri de zahăr alb stick 4g', de: 'Weiße Zuckersticks mit Logo 4g', fr: 'Sticks de sucre blanc 4g avec logo', ar: 'أظرف سكر أبيض طولية 4 جرام' } },
      { icon: '🪵', img: './assets/images/products/cleaning/product_119.jpeg', name: { en: 'Portion Brown Cane Sugar Sticks', ru: 'Тростниковый сахар в стиках с логотипом', ro: 'Plicuri de zahăr brun stick', de: 'Brauner Rohrzucker in Sticks', fr: 'Sticks de sucre roux de canne', ar: 'أظرف سكر بني قصب في عبوات' } },
      { icon: '🍅', img: './assets/images/products/cleaning/product_12.jpeg', name: { en: 'Portion Ketchup Sachets 10g', ru: 'Порционный кетчуп в саше 10г', ro: 'Sos ketchup porționat 10g', de: 'Ketchup-Portionsbeutel 10g', fr: 'Sauce ketchup en sachet 10g', ar: 'صلصة كاتشب في أظرف 10 جرام' } },
      { icon: '🟡', img: './assets/images/products/cleaning/product_120.jpeg', name: { en: 'Portion Mayonnaise & Mustard Sachets', ru: 'Порционный майонез и горчица в саше', ro: 'Maioneză și muștar porționat', de: 'Mayonnaise- & Senf-Portionsbeutel', fr: 'Mayonnaise & Moutarde en sachet', ar: 'مايونيز وخردل في أظرف فردية' } },
      { icon: '🥗', img: './assets/images/products/cleaning/product_121.jpeg', name: { en: 'Portion Pomegranate Sauce & Vinegar', ru: 'Порционный гранатовый соус и уксус', ro: 'Sos de rodie și oțet porționat', de: 'Granatapfelsauce & Essig-Portionen', fr: 'Sauce grenade & Vinaigre en portion', ar: 'صلصة الرمان والخل في عبوات' } },
      { icon: '🫒', img: './assets/images/products/cleaning/product_13.jpeg', name: { en: 'Portion Olive Oil & Salad Dressing', ru: 'Порционное оливковое масло и заправка', ro: 'Ulei de măsline porționat pentru salată', de: 'Olivenöl- & Salatdressing-Portionen', fr: 'Huile d’olive & Sauce salade en portion', ar: 'زيت زيتون وتتبيلة سلطة في عبوات' } },
      { icon: '☕', img: './assets/images/products/cleaning/product_14.jpeg', name: { en: 'Portion Instant 3-in-1 Coffee Sticks', ru: 'Растворимый кофе 3 в 1 в стиках', ro: 'Cafea instant 3 în 1 la stick', de: 'Instant-Kaffee 3-in-1 Sticks', fr: 'Café instantané 3-en-1 en stick', ar: 'قهوة سريعة التحضير 3 في 1' } },
      { icon: '🍵', img: './assets/images/products/cleaning/product_15.jpeg', name: { en: 'Portion Black Tea & Green Tea Bags', ru: 'Порционный черный и зеленый чай', ro: 'Pliculețe ceai negru și verde', de: 'Schwarz- & Grüntee-Portionsbeutel', fr: 'Sachets de thé noir & vert', ar: 'أكياس شاي أسود وأخضر فردية' } },
      { icon: '🍯', img: './assets/images/products/cleaning/product_16.jpeg', name: { en: 'Portion Honey Containers 20g', ru: 'Порционный натуральный мед 20г', ro: 'Miere naturală porționată 20g', de: 'Portionshonig 20g', fr: 'Miel naturel en pot individuel 20g', ar: 'عسل طبيعي في عبوات صغيرة 20 جرام' } },
      { icon: '🍓', img: './assets/images/products/cleaning/product_17.jpeg', name: { en: 'Portion Strawberry & Cherry Jam Cups', ru: 'Порционный клубничный и вишневый джем', ro: 'Gem de căpșuni și vișine porționat', de: 'Erdbeer- & Kirschmarmelade Portionen', fr: 'Confiture fraise & cerise en pot 20g', ar: 'مربى فراولة وكرز في عبوات صغيرة' } },
      { icon: '🍫', img: './assets/images/products/cleaning/product_18.jpeg', name: { en: 'Portion Hazelnut Chocolate Cream Cups', ru: 'Порционная шоколадно-ореховая паста', ro: 'Cremă de ciocolată cu alune porționată', de: 'Nuss-Nugat-Creme Portionsbecher', fr: 'Pâte à tartiner chocolat noisette 20g', ar: 'شوكولاتة بندق في عبوات صغيرة' } }
    ]
  },

  {
    ...
    group: 'confectionery',
    icon: '🎂',
    img: './assets/images/products/cleaning/product_19.jpeg',
    chip: {
    ...
    products: [
      { icon: '📦', img: './assets/images/products/cleaning/product_2.png', name: { en: 'Square Window Cake Boxes 25x25cm', ru: 'Квадратные коробки для тортов с окном', ro: 'Cutii pătrate pentru tort cu fereastră', de: 'Quadratische Tortenboxen mit Fenster', fr: 'Boîtes à gâteaux carrées avec fenêtre', ar: 'علب كعك مربعة مع نافذة شفافة' } },
      { icon: '🎂', img: './assets/images/products/cleaning/product_20.jpeg', name: { en: 'Tall Layer Cake Boxes with Handle', ru: 'Высокие коробки для многоярусных тортов', ro: 'Cutii înalte pentru torturi supraetajate', de: 'Hohe Etagentorten-Boxen mit Griff', fr: 'Boîtes hautes pour gâteaux à étages', ar: 'علب كعك طبقات مرتفعة بمقبض' } },
      { icon: '🪙', img: './assets/images/products/cleaning/product_21.jpeg', name: { en: 'Gold Round Cake Boards 3mm', ru: 'Золотые круглые подложки для тортов 3мм', ro: 'Discuri aurii rotunde pentru tort 3mm', de: 'Goldene runde Tortenretter 3mm', fr: 'Supports gâteaux rond Or 3mm', ar: 'أطباق كيك دائرية ذهبية 3 مم' } },
      { icon: '🥈', img: './assets/images/products/cleaning/product_22.jpeg', name: { en: 'Silver Square Cake Boards 4mm', ru: 'Серебряные квадратные подложки 4мм', ro: 'Discuri argintii pătrate 4mm', de: 'Silberne quadratische Tortenplatten 4mm', fr: 'Supports carrés Argent 4mm', ar: 'أطباق كيك مربعة فضية 4 مم' } },
      { icon: '📜', img: './assets/images/products/cleaning/product_23.jpeg', name: { en: 'Siliconized Baking Parchment Rolls', ru: 'Пергаментная бумага в рулонах для выпечки', ro: 'Hârtie de copt siliconată rola', de: 'Silikonisierte Backpapier-Rollen', fr: 'Rouleaux papier cuisson siliconé', ar: 'ورق الخبز بالفرن المغلف بالسيليكون' } },
      { icon: '🧁', img: './assets/images/products/cleaning/product_24.jpeg', name: { en: 'Disposable Heavy Duty Piping Bags 18 Inch', ru: 'Кондитерские мешки повышенной прочности 18"', ro: 'Poșuri de unică folosință rezistente 18"', de: 'Einweg-Spritzbeutel extra stark 18"', fr: 'Poches à douille jetables renforcées 18"', ar: 'أكياس تزيين الكيك سميكة 18 بوصة' } },
      { icon: '🧁', img: './assets/images/products/cleaning/product_25.jpeg', name: { en: 'Stainless Steel Pastry Nozzles Set', ru: 'Наборы стальных кондитерских насадок', ro: 'Set duiuri patiserie din inox', de: 'Edelstahl Tüllen-Set für Gebäck', fr: 'Kits douilles à pâtisserie en inox', ar: 'طقم أقماع وتزيين الحلويات الستانلس' } },
      { icon: '🧁', img: './assets/images/products/cleaning/product_26.jpeg', name: { en: 'Cupcake Boxes with 6-Hole Inserts', ru: 'Коробки для капкейков на 6 ячеек', ro: 'Cutii cupcakes cu inserție 6 locuri', de: 'Cupcake-Boxen mit 6er Inlay', fr: 'Boîtes pour 6 cupcakes avec calage', ar: 'علب الكب كيك 6 خانات' } },
      { icon: '🍬', img: './assets/images/products/cleaning/product_27.jpeg', name: { en: 'Macaron Window Gift Boxes', ru: 'Подарочные коробки для макаронс с окном', ro: 'Cutii cadou macarons cu fereastră', de: 'Macaron-Geschenkboxen mit Fenster', fr: 'Boîtes cadeaux pour macarons avec fenêtre', ar: 'علب هدايا الماكرون الفرنسية' } },
      { icon: '🍰', img: './assets/images/products/cleaning/product_28.jpeg', name: { en: 'Transparent Monoport Dessert Boxes', ru: 'Прозрачные коробки для десертов монопорций', ro: 'Cutii transparente monoporție desert', de: 'Transparente Einzeldessert-Boxen', fr: 'Boîtes transparentes pour desserts individuels', ar: 'علب الحلويات والحلويات الفردية الشفافة' } },
      { icon: '🍫', img: './assets/images/products/cleaning/product_29.jpeg', name: { en: 'Chocolate & Truffle Gift Boxes', ru: 'Коробки для конфет и трюфелей', ro: 'Cutii cadou ciocolată și trufe', de: 'Schokoladen- & Trüffel-Geschenkboxen', fr: 'Boîtes cadeaux pour chocolats & truffes', ar: 'علب شوكولاتة وترافل فاخرة' } },
      { icon: '🥐', img: './assets/images/products/cleaning/product_3.png', name: { en: 'Bakery Pie & Tart Cardboard Boxes', ru: 'Картонные коробки для пирогов и тартов', ro: 'Cutii carton pentru tarte și plăcinte', de: 'Kartonboxen für Kuchen & Tarten', fr: 'Boîtes carton pour tartes & quiches', ar: 'علب كرتون للمخبوزات والفطائر' } }
    ]
  },

  {
    ...
    group: 'food',
    icon: '🌾',
    img: './assets/images/products/cleaning/product_30.jpeg',
    chip: {
    ...
    products: [
      { icon: '🍯', img: './assets/images/products/cleaning/product_31.jpeg', name: { en: 'Portion Natural Honey 20g Jars', ru: 'Порционный натуральный мед в стекле 20г', ro: 'Miere naturală porționată la borcan 20g', de: 'Portionshonig 20g Gläser', fr: 'Miel naturel en petit pot verre 20g', ar: 'عسل طبيعي في برطمانات زجاجية 20 جرام' } },
      { icon: '🍓', img: './assets/images/products/cleaning/product_32.jpeg', name: { en: 'Portion Strawberry Jam 20g Cups', ru: 'Порционный клубничный джем 20г', ro: 'Gem de căpșuni porționat 20g', de: 'Erdbeermarmelade Portionsbecher 20g', fr: 'Confiture de fraise en barquette 20g', ar: 'مربى فراولة في عبوات 20 جرام' } },
      { icon: '🍬', img: './assets/images/products/cleaning/product_33.jpeg', name: { en: 'Refined White Sugar ICUMSA 45 (25kg)', ru: 'Белый сахар ICUMSA 45 в мешках 25кг', ro: 'Zahăr rafinat alb ICUMSA 45 (25kg)', de: 'Raffinierter weißer Zucker ICUMSA 45 (25kg)', fr: 'Sucre blanc raffiné ICUMSA 45 (25kg)', ar: 'سكر أبيض مكرر ICUMSA 45 أكياس 25 كجم' } },
      { icon: '🪵', img: './assets/images/products/cleaning/product_34.jpeg', name: { en: 'Brown Cane Sugar Bulk 25kg', ru: 'Тростниковый сахар оптом 25кг', ro: 'Zahăr brun din trestie angro 25kg', de: 'Brauner Rohrzucker in 25kg Säcken', fr: 'Sucre roux de canne en sacs de 25kg', ar: 'سكر بني قصب السكر بالجملة 25 كجم' } },
      { icon: '🧴', img: './assets/images/products/cleaning/product_35.jpeg', name: { en: 'Refined Sunflower Cooking Oil 5L', ru: 'Подсолнечное масло 5л канистры', ro: 'Ulei rafinat floarea soarelui 5L', de: 'Raffiniertes Sonnenblumenöl 5L', fr: 'Huile de tournesol raffinée 5L', ar: 'زيت عباد الشمس المكرر عبوات 5 لتر' } },
      { icon: '🫒', img: './assets/images/products/cleaning/product_36.jpeg', name: { en: 'Extra Virgin Olive Oil Bulk 18L Tin', ru: 'Оливковое масло Extra Virgin 18л', ro: 'Ulei de măsline extravirgin 18L', de: 'Natives Olivenöl Extra 18L Kanister', fr: 'Huile d’olive extra vierge 18L', ar: 'زيت زيتون بكر ممتاز صفيح 18 لتر' } },
      { icon: '🧂', img: './assets/images/products/cleaning/product_37.jpeg', name: { en: 'Ground Black Pepper Bulk 1kg', ru: 'Молотый черный перец 1кг', ro: 'Piper negru măcinat 1kg', de: 'Gemahlener schwarzer Pfeffer 1kg', fr: 'Poivre noir moulu en sac 1kg', ar: 'فلفل أسود مطحون عبوة 1 كجم' } },
      { icon: '🧂', img: './assets/images/products/cleaning/product_38.jpeg', name: { en: 'Iodized Food Grade Table Salt 25kg', ru: 'Пищевая йодированная соль 25кг', ro: 'Sare iodată alimentară 25kg', de: 'Jodiertes Speisesalz 25kg', fr: 'Sel de table iodé alimentaire 25kg', ar: 'ملح طعام يودي 25 كجم' } },
      { icon: '🌶️', img: './assets/images/products/cleaning/product_39.jpeg', name: { en: 'Red Pepper Flakes & Sweet Paprika', ru: 'Сушеный красный перец и паприка', ro: 'Fulg de ardei roșu și boia dulce', de: 'Chiliflocken & Süße Paprika', fr: 'Piment en flocons & Paprika doux', ar: 'رقائق الفلفل الأحمر والبابريكا الحلوة' } },
      { icon: '🌿', img: './assets/images/products/cleaning/product_4.png', name: { en: 'Culinary Oregano & Thyme Bulk', ru: 'Орегано и тимьян сушеный оптом', ro: 'Oregano și cimbru uscat angro', de: 'Oregano & Thymian in Großmengen', fr: 'Origan & Thyme séché en gros', ar: 'أوريغانو وزعتر مجفف بالجملة' } },
      { icon: '🌾', img: './assets/images/products/cleaning/product_40.jpeg', name: { en: 'Long Grain Basmati Rice 25kg Bags', ru: 'Рис Басмати длиннозерный 25кг', ro: 'Orez Basmati cu bob lung 25kg', de: 'Langkorn-Basmati-Reis 25kg Säcke', fr: 'Riz Basmati grain long sacs 25kg', ar: 'أرز بسمتي طويل الحبة أكياس 25 كجم' } },
      { icon: '🫘', img: './assets/images/products/confectionery/product_1.png', name: { en: 'Red & Green Lentils Bulk 25kg', ru: 'Красная и зеленая чечевица оптом 25кг', ro: 'Linte roșie și verde angro 25kg', de: 'Rote & Grüne Linsen in 25kg Säcken', fr: 'Lentilles rouges & vertes en sacs 25kg', ar: 'عدس أحمر وأخضر بالجملة 25 كجم' } }
    ]
  },

  {
    ...
    group: 'cleaning',
    icon: '🧼',
    img: './assets/images/products/confectionery/product_10.png',
    chip: {
    ...
    products: [
      { icon: '🧴', img: './assets/images/products/confectionery/product_100.jpeg', name: { en: 'Concentrated Lemon Dishwashing Liquid 5L', ru: 'Концентрат для мытья посуды Лимон 5л', ro: 'Detergent concentrat vase Lămâie 5L', de: 'Konzentriertes Zitrone Spülmittel 5L', fr: 'Liquide vaisselle concentré citron 5L', ar: 'سائل غسيل الأطباق بالليمون مركز 5 لتر' } },
      { icon: '🍽️', img: './assets/images/products/confectionery/product_101.jpeg', name: { en: 'Commercial Dishwasher Rinse Aid 10L', ru: 'Ополаскиватель для посудомоечных машин 10л', ro: 'Lichid clătire mașină spălat vase 10L', de: 'Klarspüler für gewerbliche Spülmaschinen 10L', fr: 'Liquide de rinçage vaisselle pro 10L', ar: 'مساعد شطف غسالات الأطباق الصناعية 10 لتر' } },
      { icon: '🧽', img: './assets/images/products/confectionery/product_102.jpeg', name: { en: 'Floor Disinfectant Lavender 5L', ru: 'Дезинфицирующее средство для полов Лаванда 5л', ro: 'Dezinfectant pardoseli Levănțică 5L', de: 'Bodendesinfektionsmittel Lavendel 5L', fr: 'Désinfectant sols lavande 5L', ar: 'مطهر ومعطر أرضيات باللافندر 5 لتر' } },
      { icon: '🧴', img: './assets/images/products/confectionery/product_103.jpeg', name: { en: 'Surface Sanitizer Spray 750ml', ru: 'Спрей дезинфекция поверхностей 750мл', ro: 'Spray dezinfectant suprafețe 750ml', de: 'Flächendesinfektionsspray 750ml', fr: 'Désinfectant surfaces spray 750ml', ar: 'بخاخ تعقيم الأسطح 750 مل' } },
      { icon: '🧺', img: './assets/images/products/confectionery/product_104.jpeg', name: { en: 'Industrial Laundry Powder Detergent 20kg', ru: 'Стиральный порошок для прачечных 20кг', ro: 'Detergent pudră spălătorie industrială 20kg', de: 'Industrielles Waschpulver 20kg', fr: 'Lessive poudre industrielle 20kg', ar: 'مسحوق غسيل صناعي للمغاسل 20 كجم' } },
      { icon: '🌸', img: './assets/images/products/confectionery/product_105.jpeg', name: { en: 'Fabric Softener & Conditioner 10L', ru: 'Кондиционер для белья 10л', ro: 'Balsam rufe concentrat 10L', de: 'Weichspüler & Konditionierer 10L', fr: 'Adoucissant & assouplissant textile 10L', ar: 'معطر ومنعم ملابس مركز 10 لتر' } },
      { icon: '🧼', img: './assets/images/products/confectionery/product_106.jpeg', name: { en: 'Antibacterial Liquid Hand Soap 5L', ru: 'Антибактериальное жидкое мыло 5л', ro: 'Săpun lichid antibacterian 5L', de: 'Antibakterielle Flüssighandseife 5L', fr: 'Savon liquide antibactérien 5L', ar: 'صابون أيدي سائل مضاد للبكتيريا 5 لتر' } },
      { icon: '🧼', img: './assets/images/products/confectionery/product_107.jpeg', name: { en: 'Foam Hand Soap Refill Canister 5L', ru: 'Пенное мыло для рук канистра 5л', ro: 'Spumă săpun mâini rezerve 5L', de: 'Schaumseife-Nachfüllung 5L', fr: 'Recharge savon mousse 5L', ar: 'صابون رغوة سائل عبوة 5 لتر' } },
      { icon: '🪟', img: './assets/images/products/confectionery/product_108.jpeg', name: { en: 'Glass & Mirror Cleaner Spray 750ml', ru: 'Средство для стекол и зеркал 750мл', ro: 'Detergent geamuri și oglinzi 750ml', de: 'Glas- & Spiegelreiniger Spray 750ml', fr: 'Nettoyant vitres & miroirs 750ml', ar: 'منظف وملمع الزجاج والمرايا 750 مل' } },
      { icon: '🍳', img: './assets/images/products/confectionery/product_109.jpeg', name: { en: 'Heavy Duty Kitchen Degreaser 5L', ru: 'Средство от жира на кухне 5л', ro: 'Degresant bucătărie profesional 5L', de: 'Starker Küchenentfetter 5L', fr: 'Dégraissant cuisine puissant 5L', ar: 'منظف ومزيل دهون المطابخ الثقيلة 5 لتر' } },
      { icon: '🧪', img: './assets/images/products/confectionery/product_11.jpeg', name: { en: 'Chlorinated Bleach Sanitizer 5L', ru: 'Хлорный отбеливатель и дезинфектант 5л', ro: 'Inălbitor clorurat dezinfectant 5L', de: 'Chlor-Bleich- & Desinfektionsmittel 5L', fr: 'Eau de Javel désinfectante 5L', ar: 'مبيض ومطهر كلور مركز 5 لتر' } },
      { icon: '🚽', img: './assets/images/products/confectionery/product_110.jpeg', name: { en: 'Toilet Bowl Cleaner Acid Gel 1L', ru: 'Гель для чистки унитазов 1л', ro: 'Gel acid curățare toaletă 1L', de: 'Säure-WC-Reiniger Gel 1L', fr: 'Gel nettoyant WC acide 1L', ar: 'جل تنظيف وتعقيم الحمامات 1 لتر' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🌿',
    img: './assets/images/products/confectionery/product_111.jpeg',
    chip: {
    ...
    products: [
      { icon: '☕', img: './assets/images/products/confectionery/product_112.jpeg', name: { en: 'Valved Roasted Coffee Bean Doypack 250g', ru: 'Пакеты для кофе с клапаном 250г', ro: 'Pungi cafea cu supapă 250g', de: 'Kaffeebeutel mit Ventil 250g', fr: 'Sachets café avec valve 250g', ar: 'أكياس لحفظ البن المزودة بصمام 250 جرام' } },
      { icon: '🫘', img: './assets/images/products/confectionery/product_113.jpeg', name: { en: 'Rectangular Window Kraft Doypack 500g', ru: 'Крафт дойпак с прямоугольным окном 500г', ro: 'Pungi Doypack kraft cu fereastră dreptunghiulară', de: 'Rechteckfenster Kraft Doypack 500g', fr: 'Sachets Doypack kraft fenêtre rectangulaire', ar: 'أكياس كرافت مع نافذة مستطيلة 500 جرام' } },
      { icon: '🥜', img: './assets/images/products/confectionery/product_114.jpeg', name: { en: 'Oval Window Stand-Up Kraft Pouch', ru: 'Крафт дойпак с овальным окном', ro: 'Pungi Doypack kraft cu fereastră ovală', de: 'Ovalfenster Kraft Stehbeutel', fr: 'Sachets kraft fenêtre ovale', ar: 'أكياس كرافت وقوفية نافذة بيضاوية' } },
      { icon: '✨', img: './assets/images/products/confectionery/product_115.png', name: { en: 'Full Transparent Front Kraft Back Doypack', ru: 'Дойпак с прозрачным фасадом и крафт спинкой', ro: 'Pungi Doypack fața transparentă spate kraft', de: 'Transparente Front Kraft-Rücken Doypack', fr: 'Doypack face transparente dos kraft', ar: 'أكياس كرافت جانب شفاف بالكامل' } },
      { icon: '🖤', img: './assets/images/products/food/product_41.png', name: { en: 'Matte Black Aluminum Barrier Zip Pouch', ru: 'Матовые черные дойпаки с фольгой', ro: 'Pungi Doypack negru mat cu aluminiu', de: 'Mattschwarze Alu-Barriere-Zip-Beutel', fr: 'Sachets noir mat barrière alu zip', ar: 'أكياس دوي باك سوداء فاخرة مع سحاب' } },
      { icon: '🤍', img: './assets/images/products/food/product_42.jpeg', name: { en: 'Matte White Aluminum Foil Doypack', ru: 'Матовые белые фольгированные дойпаки', ro: 'Pungi Doypack alb mat cu aluminiu', de: 'Mattweiße Alu-Barriere-Zip-Beutel', fr: 'Sachets blanc mat barrière alu zip', ar: 'أكياس دوي باك بيضاء مع عازل ألومنيوم' } },
      { icon: '🧴', img: './assets/images/products/food/product_43.png', name: { en: 'Kraft Pouch with Liquid Spout & Cap', ru: 'Крафт дойпак с носиком-дозатором', ro: 'Pungi kraft cu dop pentru lichide', de: 'Kraft-Standbeutel mit Ausgießer & Kappe', fr: 'Sachet kraft avec bouchon verseur', ar: 'أكياس كرافت وقوفية مع صنبور صب' } },
      { icon: '🪙', img: './assets/images/products/food/product_44.jpeg', name: { en: 'Metallic Silver Vacuum Zip Pouch', ru: 'Серебряные вакуумные дойпаки', ro: 'Pungi argintii metalizate cu fermoar', de: 'Silberne Metall-Vakuum-Zip-Beutel', fr: 'Sachets sous vide argentés avec zip', ar: 'أكياس تفريغ الهواء الفضية مع سحاب' } },
      { icon: '🌱', img: './assets/images/products/food/product_45.png', name: { en: 'Eco Compostable PLA Barrier Zip Bag', ru: 'Биоразлагаемые дойпаки из PLA', ro: 'Pungi bio compostabile PLA cu fermoar', de: 'Kompostierbare PLA Barriere-Zip-Beutel', fr: 'Sachets compostables PLA barrière zip', ar: 'أكياس دوي باك عضوية قابلة للتحلل' } },
      { icon: '☕', img: './assets/images/products/food/product_46.jpeg', name: { en: 'Side Gusseted Coffee Valve Bag 1kg', ru: 'Пакеты для кофе с фальцами и клапаном 1кг', ro: 'Pungi cafea pliu lateral cu supapă 1kg', de: 'Seitenfalten-Kaffeebeutel mit Ventil 1kg', fr: 'Sachets café soufflets latéraux valve 1kg', ar: 'أكياس بن بطيات جانبية وصمام 1 كجم' } },
      { icon: '📦', img: './assets/images/products/food/product_47.jpeg', name: { en: 'Flat Bottom Quad Seal Box Pouch', ru: 'Пакеты с плоским дном 4-х шовные', ro: 'Pungi cu fund plat 4 sigilii', de: 'Flachboden-Standbeutel mit 4 Nähten', fr: 'Sachets fond plat 4 soudures', ar: 'أكياس قاع مسطح أربعة لحامات' } },
      { icon: '🌰', img: './assets/images/products/food/product_48.jpeg', name: { en: 'Dried Fruit & Nuts Kraft Window Pouch', ru: 'Крафт пакеты для сухофруктов и орехов', ro: 'Pungi kraft pentru fructe uscate și alune', de: 'Kraftbeutel für Trockenfrüchte & Nüsse', fr: 'Sachets kraft pour fruits secs & noix', ar: 'أكياس كرافت للمكسرات والفواكه المجففة' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🛍️',
    img: './assets/images/products/food/product_49.jpeg',
    chip: {
    ...
    products: [
      { icon: '🛍️', img: './assets/images/products/food/product_5.jpeg', name: { en: 'Brown Kraft Bags with Twisted Handles', ru: 'Бурые крафт-пакеты с кручеными ручками', ro: 'Pungi kraft natur cu mânere răsucite', de: 'Braune Krafttaschen mit gedrehtem Henkel', fr: 'Sacs kraft brun poignées torsadées', ar: 'أكياس كرافت بني بمقابض ورقية ملتوية' } },
      { icon: '🛍️', img: './assets/images/products/food/product_50.jpeg', name: { en: 'Bleached White Kraft Bags with Handles', ru: 'Белые крафт-пакеты с кручеными ручками', ro: 'Pungi kraft alb cu mânere răsucite', de: 'Weiße Krafttaschen mit gedrehtem Henkel', fr: 'Sacs kraft blanc poignées torsadées', ar: 'أكياس كرافت أبيض بمقابض ملتوية' } },
      { icon: '🍔', img: './assets/images/products/food/product_51.jpeg', name: { en: 'Flat Handle Takeaway Bags for Food Delivery', ru: 'Пакеты с плоскими ручками для доставки еды', ro: 'Pungi mânere plate pentru livrare mâncare', de: 'Flachhenkel-Taschen für Essen-Lieferservice', fr: 'Sacs poignées meplat livraison repas', ar: 'أكياس كرافت بمقابض مسطحة لتوصيل الطعام' } },
      { icon: '💼', img: './assets/images/products/food/product_52.png', name: { en: 'Rope Handle Luxury Boutiques Shoppers', ru: 'Крафт-пакеты с веревочными ручками для бутиков', ro: 'Pungi kraft de lux cu șnur pentru boutique', de: 'Luxus-Krafttaschen mit Kordel für Boutiquen', fr: 'Sacs kraft de luxe cordons pour boutiques', ar: 'أكياس كرافت فاخرة بمقابض حبال للمتاجر' } },
      { icon: '🥖', img: './assets/images/products/food/product_53.png', name: { en: 'SOS Block Bottom Bakery Bags (No Handles)', ru: 'Пакеты без ручек с прямоугольным дном', ro: 'Pungi fără mânere cu fund dreptunghiular', de: 'SOS-Blockbodenbeutel ohne Henkel', fr: 'Sacs fond bloc sans poignées boulangerie', ar: 'أكياس كرافت قاع مستطيل للمخابز بدون مقابض' } },
      { icon: '🍷', img: './assets/images/products/food/product_54.jpeg', name: { en: 'Single Wine & Bottle Carrier Paper Bags', ru: 'Бумажные пакеты для 1 бутылки вина', ro: 'Pungi hârtie pentru o sticlă de vin', de: 'Einzelne Flaschen-Papiertaschen', fr: 'Sacs papier pour 1 bouteille de vin', ar: 'أكياس ورقية مخصصة لزجاجة نبيذ واحدة' } },
      { icon: '🍾', img: './assets/images/products/food/product_55.jpeg', name: { en: 'Two-Bottle Wine Paper Carrier Bags', ru: 'Бумажные пакеты для 2 бутылок с разделителем', ro: 'Pungi hârtie pentru 2 sticle cu despărțitor', de: 'Doppel-Flaschen-Papiertaschen', fr: 'Sacs papier pour 2 bouteilles avec séparation', ar: 'أكياس ورقية مخصصة لحمل زجاجتين' } },
      { icon: '📦', img: './assets/images/products/food/product_56.jpeg', name: { en: 'Wide Bottom Takeaway Burger Carrier Bags', ru: 'Широкие пакеты для коробок с бургерами', ro: 'Pungi late pentru cutii burgeri', de: 'Breitboden-Taschen für Burger-Boxen', fr: 'Sacs grand fond pour boîtes à burgers', ar: 'أكياس كرافت عريضة القاع لعلب الوجبات' } },
      { icon: '🛍️', img: './assets/images/products/food/product_57.jpeg', name: { en: 'Die-Cut Handle Kraft Shopping Bags', ru: 'Крафт-пакеты с прорубной ручкой', ro: 'Pungi kraft cu mâner decupat', de: 'Kraft-Grifflochbeutel', fr: 'Sacs kraft à poignées découpées', ar: 'أكياس كرافت بفتحات يد مقصوصة' } },
      { icon: '✨', img: './assets/images/products/food/product_58.jpeg', name: { en: 'Laminated Foil Stamped Gift Paper Bags', ru: 'Ламинированные пакеты с тиснением фольгой', ro: 'Pungi cadou din hârtie laminate cu folio', de: 'Laminierte Geschenk-Papiertaschen mit Folienprägung', fr: 'Sacs papier cadeau laminés dorure à chaud', ar: 'أكياس ورقية فاخرة مطبوعة بالبصمة الذهبية' } },
      { icon: '💎', img: './assets/images/products/food/product_59.jpeg', name: { en: 'Mini Jewelry & Cosmetic Kraft Bags', ru: 'Мини-пакеты для ювелирных изделий и косметики', ro: 'Pungi mini pentru bijuterii și cosmetice', de: 'Mini-Krafttaschen für Schmuck & Kosmetik', fr: 'Mini sacs kraft pour bijoux & cosmétiques', ar: 'أكياس كرافت صغيرة للمجوهرات ومستحضرات التجميل' } },
      { icon: '📦', img: './assets/images/products/food/product_6.jpeg', name: { en: 'Heavy Duty Reinforced Bottom Shipping Bags', ru: 'Пакеты повышенной прочности с усиленным дном', ro: 'Pungi rezistente cu fund ranforsat', de: 'Strapazierfähige Versandtaschen mit verstärktem Boden', fr: 'Sacs d’expédition haute résistance fond renforcé', ar: 'أكياس ورقية سميكة ذات قاع مقوى للأوزان' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🧻',
    img: './assets/images/products/food/product_60.jpeg',
    chip: {
    ...
    products: [
      { icon: '💧', img: './assets/images/products/food/product_61.jpeg', name: { en: 'Single Sachet Refreshing Wet Wipes 6x8cm', ru: 'Влажные салфетки в саше 6х8см с логотипом', ro: 'Șervețele umede la plic 6x8cm cu logo', de: 'Erfrischungstücher im Sachet 6x8cm', fr: 'Lingettes rince-doigts individuelles 6x8cm', ar: 'مناديل مبللة معطرة في أظرف 6x8 سم' } },
      { icon: '💧', img: './assets/images/products/food/product_62.jpeg', name: { en: 'Large Sachet Wet Wipes 7x12cm', ru: 'Влажные салфетки большого формата 7х12см', ro: 'Șervețele umede format mare 7x12cm', de: 'Große Erfrischungstücher 7x12cm', fr: 'Lingettes rafraîchissantes grand format 7x12cm', ar: 'مناديل مبللة حجك كبير 7x12 سم' } },
      { icon: '✈️', img: './assets/images/products/food/product_63.jpeg', name: { en: 'Airline & Hotel Hot/Cold Refreshing Towels', ru: 'Освежающие махровые полотенца для авиалиний', ro: 'Prosoape umede calde/reci pentru linii aeriene', de: 'Heiße/Kalte Erfrischungstücher für Airlines', fr: 'Serviettes rafraîchissantes chaudes/froides airlines', ar: 'مناشف حارة/باردة معطرة للطيران والفنادق' } },
      { icon: '🛡️', img: './assets/images/products/food/product_64.jpeg', name: { en: 'Alcohol-Free Antimicrobial Sanitizing Wipes', ru: 'Антибактериальные салфетки без спирта', ro: 'Șervețele dezinfectante fără alcool', de: 'Alkoholfreie antibakterielle Feuchttücher', fr: 'Lingettes désinfectantes sans alcool', ar: 'مناديل معقمة خالية من الكحول' } },
      { icon: '🧻', img: './assets/images/products/food/product_65.jpeg', name: { en: 'Dispenser Refill Napkins (1/4 Fold)', ru: 'Салфетки для диспенсеров 1/4 сложения', ro: 'Rezerve șervețele dispenser 1/4 împăturite', de: 'Spenderservietten-Nachfüllung 1/4 Falz', fr: 'Serviettes pour distributeur pliage 1/4', ar: 'مناديل لموزعات المناديل طية 1/4' } },
      { icon: '🍸', img: './assets/images/products/food/product_66.jpeg', name: { en: 'Cocktail Paper Napkins 2-Ply 24x24cm', ru: 'Коктейльные салфетки 2 слоя 24х24см', ro: 'Șervețele cocktail 2 straturi 24x24cm', de: 'Cocktail-Servietten 2-lagig 24x24cm', fr: 'Serviettes cocktail 2 plis 24x24cm', ar: 'مناديل كوكتيل طبقتين 24x24 سم' } },
      { icon: '🍽️', img: './assets/images/products/food/product_67.jpeg', name: { en: 'Dinner Paper Napkins 2-Ply 33x33cm', ru: 'Столовые салфетки 2 слоя 33х33см', ro: 'Șervețele masă 2 straturi 33x33cm', de: 'Mahlzeit-Servietten 2-lagig 33x33cm', fr: 'Serviettes de table 2 plis 33x33cm', ar: 'مناديل طعام طبقتين 33x33 سم' } },
      { icon: '✨', img: './assets/images/products/food/product_68.jpeg', name: { en: 'Airlaid Linen-Feel Luxury Napkins 40x40cm', ru: 'Премиум салфетки под лен Airlaid 40х40см', ro: 'Șervețele de lux textura in Airlaid 40x40cm', de: 'Airlaid Stoffstruktur-Servietten 40x40cm', fr: 'Serviettes de luxe effet tissu Airlaid 40x40cm', ar: 'مناديل قماشية فاخرة ملمس الكتان 40x40 سم' } },
      { icon: '🍴', img: './assets/images/products/hotel/product_85.jpeg', name: { en: 'Cutlery Pocket Napkins with Fork Slot', ru: 'Салфетки-кармашки для приборов', ro: 'Șervețele cu buzunar pentru tacâmuri', de: 'Bestecktaschen-Servietten mit Schlitz', fr: 'Serviettes étui pochette pour couverts', ar: 'مناديل مع جيب مخصص لأطقم الشوك والسكاكين' } },
      { icon: '📦', img: './assets/images/products/hotel/product_86.jpeg', name: { en: 'Pocket Tissue 10-Packs with Logo Wrap', ru: 'Карманные бумажные платочки 10 шт в упаковке', ro: 'Pachete șervețele buzunar 10 buc cu logo', de: 'Taschentücher-Packungen 10er mit Logo', fr: 'Étuis mouchoirs de poche 10 unités avec logo', ar: 'مناديل جيب ورقية 10 مناديل مطبوعة' } },
      { icon: '🧻', img: './assets/images/products/hotel/product_87.jpeg', name: { en: 'Z-Fold & V-Fold Paper Hand Towels', ru: 'Бумажные полотенца Z-сложения и V-сложения', ro: 'Prosoape hârtie mâini pliate Z și V', de: 'Papierhandtücher Z-Falz & V-Falz', fr: 'Essuie-mains papier pliage Z & V', ar: 'مناشف ورقية للأيدي طية Z و V' } },
      { icon: '🌀', img: './assets/images/products/hotel/product_88.jpeg', name: { en: 'Centerfeed Paper Towel Rolls 2-Ply', ru: 'Бумажные полотенца в рулонах с центральной вытяжкой', ro: 'Prosoape hârtie rola cu derulare centrală', de: 'Innenabrollung Papierhandtuchrollen 2-lagig', fr: 'Rouleaux essuie-mains dévidage central 2 plis', ar: 'رول مناشف سحب من المنتصف طبقتين' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🍴',
    img: './assets/images/products/hotel/product_89.jpeg',
    chip: {
...

  {
    ...
    group: 'packaging',
    icon: '📜',
    img: './assets/images/products/packaging/product_75.jpeg',
    chip: {
    ...
    products: [
      { icon: '🍔', img: './assets/images/products/packaging/product_76.jpeg', name: { en: 'Greaseproof Burger Wrap Sheets KIT 7 30x40cm', ru: 'Жиростойкая бумага для обертывания бургеров 30х40см', ro: 'Hârtie anti-grăsime ambalare burgeri 30x40cm', de: 'Fettdichtes Burger-Einwickelpapier 30x40cm', fr: 'Papier ingraissable pour burgers 30x40cm', ar: 'أوراق تغليف البرجر المضادة للدهون 30x40 سم' } },
      { icon: '🥩', img: './assets/images/products/packaging/product_77.jpeg', name: { en: 'PE-Coated Butcher Paper Sheets for Meats', ru: 'Бумага для мясной гастрономии с PE-покрытием', ro: 'Hârtie măcelărie laminată PE', de: 'PE-beschichtetes Einschlagpapier für Fleisch', fr: 'Papier boucherie plastifié PE pour viandes', ar: 'ورق مغلف للحوم والمأكولات الطازجة' } },
      { icon: '🥪', img: './assets/images/products/packaging/product_78.jpeg', name: { en: 'Newspaper Print Custom Sandwich Wraps', ru: 'Бумага для сэндвичей с газетным принтом', ro: 'Hârtie ambalat sandwich model ziar', de: 'Bedrucktes Sandwich-Papier Zeitungsmuster', fr: 'Papier emballage sandwich motif journal', ar: 'أوراق تغليف الساندويشات بطبعة الصحيفة' } },
      { icon: '🧺', img: './assets/images/products/packaging/product_79.jpeg', name: { en: 'Basket & Metal Tray Liner Paper Sheets', ru: 'Бумажные вкладыши для сервировочных корзинок', ro: 'Foi de hârtie pentru coșulețe și tăvi', de: 'Korb- & Tablett-Einlegebögen', fr: 'Feuilles de fond pour paniers & plateaux', ar: 'أوراق بطانة السلال وصواني التقديم' } },
      { icon: '🥐', img: './assets/images/products/packaging/product_8.jpeg', name: { en: 'Bakery Waxed Wrapping Sheets for Pastries', ru: 'Вощеная бумага для пекарен и выпечки', ro: 'Hârtie cerată pentru patiserie', de: 'Gewachstes Bäckerei-Einschlagpapier', fr: 'Papier paraffiné pour boulangerie', ar: 'ورق مغلف بالشمع للمخابز والمعجنات' } },
      { icon: '🌯', img: './assets/images/products/packaging/product_80.jpeg', name: { en: 'Aluminum Foil Laminated Wrap Sheets', ru: 'Фольгированная бумага для шаурмы и дурума', ro: 'Foi laminat aluminiu pentru shawarma', de: 'Alufolie-laminierte Einschlagbögen', fr: 'Feuilles laminées alu pour kebabs', ar: 'أوراق مغلفة بالألومنيوم للشاورما والوجبات' } },
      { icon: '📜', img: './assets/images/products/packaging/product_81.jpeg', name: { en: 'Pergamyn Translucent Bakery Wrapping Paper', ru: 'Пергамин прозрачная упаковочная бумага', ro: 'Hârtie translucentă pergamyn patiserie', de: 'Pergamyn transparentes Bäckereipapier', fr: 'Papier pergamyn translucide boulangerie', ar: 'ورق برجامين شفاف للمخابز' } },
      { icon: '🎂', img: './assets/images/products/packaging/product_82.jpeg', name: { en: 'Siliconized Pan Liner Sheets 40x60cm', ru: 'Силиконизированные листы для противней 40х60см', ro: 'Foi siliconate pentru tăvi copt 40x60cm', de: 'Silikonisierte Backblech-Einlagen 40x60cm', fr: 'Feuilles siliconées pour plaques cuisson 40x60cm', ar: 'أوراق سيليكون للصواني بالفرن 40x60 سم' } },
      { icon: '🥖', img: './assets/images/products/packaging/product_83.jpeg', name: { en: 'Food Grade Tissue Wrapping Sheets for Bread', ru: 'Тонкая пищевая бумага для обертывания хлеба', ro: 'Hârtie subțire alimentară ambalat pâine', de: 'Dünnes Seidenpapier für Brot', fr: 'Papier de soie alimentaire pour pain', ar: 'ورق تغليف رقيق وخفيف للخبز' } },
      { icon: '❄️', img: './assets/images/products/packaging/product_84.jpeg', name: { en: 'Poly-Coated Freezer Paper Sheets', ru: 'Бумага с полимерным слоем для заморозки', ro: 'Hârtie laminată pentru congelare', de: 'Poly-beschichtetes Gefrierpapier', fr: 'Papier plastifié pour congélation', ar: 'ورق مقوى مغلف للتجميد بحفظ اللحوم' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🍱',
    img: './assets/images/products/perfume/product_94.jpeg',
    chip: {
    ...
    products: [
      { icon: '🍣', img: './assets/images/products/perfume/product_95.jpeg', name: { en: 'Anti-Fog Bento Sushi Trays (Small)', ru: 'Контейнеры для суши маленькие с крышкой anti-fog', ro: 'Caserole sushi mici cu capac anti-aburire', de: 'Anti-Beschlag Sushi Bento Trays Klein', fr: 'Barquettes sushi bento anti-buée small', ar: 'عبوات سوشي بينتو حجم صغير' } },
      { icon: '🍱', img: './assets/images/products/perfume/product_96.jpeg', name: { en: 'Large Party Size Sushi Platter Trays', ru: 'Большие подносы для сет-наборов суши', ro: 'Tăvi mari Sushi Party Platter', de: 'Große Party-Sushi-Platten', fr: 'Plateaux repas sushi taille party', ar: 'أطباق سوشي حجم عائلي وكبير' } },
      { icon: '🥢', img: './assets/images/products/perfume/product_97.jpeg', name: { en: 'Bamboo Chopsticks in Printed Sleeves', ru: 'Бамбуковые палочки в бумажной упаковке', ro: 'Bețișoare bambus în plic ambalat', de: 'Bambus-Essstäbchen in bedruckter Hülle', fr: 'Baguettes en bambou en étui papier imprimé', ar: 'عيدان أكل الخيزران في أظرف ورقية' } },
      { icon: '🐟', img: './assets/images/products/perfume/product_98.jpeg', name: { en: 'Soy Sauce Fish Bottles 8ml & 15ml', ru: 'Бутылочки «рыбки» для соевого соуса 8мл и 15мл', ro: 'Sticluțe peștișor sos soia 8ml și 15ml', de: 'Sojasaucen-Fischfläschchen 8ml & 15ml', fr: 'Flacons poisson pour sauce soja 8ml & 15ml', ar: 'عبوات صويا صوص شكل سمكة 8 و 15 مل' } },
      { icon: '🍜', img: './assets/images/unused/product_1.png', name: { en: 'Round Kraft Wok & Noodle Boxes', ru: 'Круглые коробочки для лапши вок', ro: 'Cutii rotunde pentru tăieței wok', de: 'Runde Wok-Nudelboxen', fr: 'Boîtes rondes pour nouilles wok', ar: 'علب نودلز ووك كرافت دائرية' } },
      { icon: '🍲', img: './assets/images/unused/product_10.png', name: { en: 'Leak-Proof Ramen Soup Bowls with Lids', ru: 'Герметичные миски для рамэна и супов', ro: 'Boluri etanșe pentru supe și ramen', de: 'Auslaufsichere Schalen für Ramen-Suppen', fr: 'Bols étanches pour soupes ramen', ar: 'أوعية شوربة الرامن محكمة الإغلاق' } },
      { icon: '🍙', img: './assets/images/unused/product_100.jpeg', name: { en: 'Triangular Onigiri Rice Ball Wrapping Film', ru: 'Пленка для упаковки онигири с лентой', ro: 'Folie ambalat onigiri cu bandă', de: 'Dreieckige Onigiri-Verpackungsfolie', fr: 'Film d’emballage onigiri triangle', ar: 'أغلفة الأرز المثلث أونيجيري' } },
      { icon: '🥟', img: './assets/images/unused/product_101.jpeg', name: { en: 'Asian Dumpling & Dim Sum Steam Trays', ru: 'Контейнеры для пельменей дамблингов и димсамов', ro: 'Caserole pentru colțunași și dim sum', de: 'Dim-Sum & Dumpling-Dämpfbehälter', fr: 'Barquettes pour raviolis asiatiques & dim sum', ar: 'أطباق وعلب الفطائر الآسيوية الديم سم' } },
      { icon: '🧂', img: './assets/images/unused/product_102.jpeg', name: { en: 'Wasabi & Ginger Portion Sauce Dishes', ru: 'Соусники для васаби и имбиря', ro: 'Caserole mici pentru wasabi și ghimbir', de: 'Portionsschälchen für Wasabi & Ingwer', fr: 'Ramequins pour wasabi & gingembre', ar: 'عبوات صغيرة للواسابي والزنجبيل' } },
      { icon: '🥢', img: './assets/images/unused/product_103.jpeg', name: { en: 'Chopstick Rest Holders & Wooden Trays', ru: 'Подставки для палочек и деревянные подносы', ro: 'Suporturi bețișoare și tăvi din lemn', de: 'Essstäbchen-Bänke & Holz-Trays', fr: 'Repose-baguettes & plateaux en bois', ar: 'مساند خشبية لعيدان الأكل والصواني' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🌱',
    img: './assets/images/unused/product_104.jpeg',
    chip: {
    ...
    products: [
      { icon: '🌱', img: './assets/images/unused/product_105.jpeg', name: { en: 'OK Compost Certified Cornstarch T-Shirt Bags', ru: 'Биоразлагаемые пакеты-майка с сертификатом OK Compost', ro: 'Pungi maieu din amidon de porumb OK Compost', de: 'OK Compost Maisstärke T-Shirt-Tragetaschen', fr: 'Sacs bretelles en amidon de maïs OK Compost', ar: 'أكياس علاقية من نشا الذرة معتمدة قابلة للتحلل' } },
      { icon: '🛍️', img: './assets/images/unused/product_106.jpeg', name: { en: 'Bio Die-Cut Handle Retail Shopping Bags', ru: 'Био-пакеты с вырубной ручкой для магазинов', ro: 'Pungi bio cu mâner decupat pentru magazine', de: 'Bio-Grifflochbeutel für den Einzelhandel', fr: 'Sacs bio à poignées découpées pour magasins', ar: 'أكياس تجارية عضويات قابلة للتحلل بمقابض' } },
      { icon: '🍏', img: './assets/images/unused/product_107.jpeg', name: { en: 'Compostable Produce Roll Bags for Supermarkets', ru: 'Био-пакеты в рулонах для овощей и фруктов', ro: 'Pungi rola biodegradabile pentru fructe și legume', de: 'Kompostierbare Knotenbeutel auf Rolle', fr: 'Sacs en rouleaux compostables pour fruits & légumes', ar: 'أكياس رول قابلة للتحلل للخضار للفواكه' } },
      { icon: '🗑️', img: './assets/images/unused/product_108.jpeg', name: { en: 'Organic Waste Compostable Trash Bags 30L/60L', ru: 'Биоразлагаемые мешки для органического мусора 30л/60л', ro: 'Saci menajeri biodegradabili pentru deșeuri 30L/60L', de: 'Biologisch abbaubare Müllbeutel 30L/60L', fr: 'Sacs poubelle compostables pour déchets bio 30L/60L', ar: 'أكياس نفايات حيوية قابلة للتحلل 30 و 60 لتر' } },
      { icon: '🌾', img: './assets/images/unused/product_109.jpeg', name: { en: 'PLA Bio Barrier Stretch Shrink Film', ru: 'Биоразлагаемая стретч-пленка PLA', ro: 'Folie barieră stretch biodegradabilă PLA', de: 'PLA Bio-Dehn- & Schrumpffolie', fr: 'Film étirable & rétractable bio PLA', ar: 'رول استرتش حيوي عازل قابل للتحلل' } },
      { icon: '🚜', img: './assets/images/unused/product_11.jpeg', name: { en: 'Bio Agricultural Mulch Film Rolls', ru: 'Биоразлагаемая мульчирующая пленка для агро', ro: 'Folie biodegradabilă pentru mulcire agricolă', de: 'Biologisch abbaubare Agrar-Mulchfolie', fr: 'Film de paillage agricole biodégradable', ar: 'رول بلاستيك زراعي حيوي للتربة' } },
      { icon: '✉️', img: './assets/images/unused/product_110.jpeg', name: { en: 'Biodegradable Courier & Mailing Envelopes', ru: 'Биоразлагаемые курьерские пакеты', ro: 'Pungi curierat biodegradabile pentru expediții', de: 'Biologisch abbaubare Kurier- & Versandtaschen', fr: 'Pochettes d’expédition biodégradables', ar: 'أظرف وأكياس شحن بريدي حيوية قابلة للتحلل' } },
      { icon: '🥖', img: './assets/images/unused/product_111.jpeg', name: { en: 'Bio Bread & Bakery Bags with Window', ru: 'Био-пакеты для хлеба с окошком', ro: 'Pungi bio pentru pâine cu fereastră', de: 'Bio-Brotbeutel mit Sichtfenster', fr: 'Sacs à pain bio avec fenêtre', ar: 'أكياس خبز عضوية قابلة للتحلل مع نافذة' } },
      { icon: '🤐', img: './assets/images/unused/product_112.jpeg', name: { en: 'Home Compostable Zip Lock Storage Bags', ru: 'Домашние биоразлагаемые зип-пакеты', ro: 'Pungi cu fermoar compostabile acasă', de: 'Heimkompostierbare Druckverschlussbeutel', fr: 'Sachets zip compostables à domicile', ar: 'أكياس بسحاب حفظ منزلية قابلة للتحلل' } },
      { icon: '📦', img: './assets/images/unused/product_113.jpeg', name: { en: 'PBAT Eco Bubble Wrap Protective Roll', ru: 'Биоразлагаемая воздушно-пузырьковая пленка', ro: 'Folie cu bule biodegradabilă PBAT', de: 'Biologisch abbaubare Luftpolsterfolie PBAT', fr: 'Film à bulles biodégradable PBAT', ar: 'رولفقاعات حماية حيوية PBAT' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🛍️',
    img: './assets/images/unused/product_114.jpeg',
    chip: {
    ...
    products: [
      { icon: '🛍️', img: './assets/images/unused/product_115.png', name: { en: 'Non-Woven Spunbond Shopping Bags 80gsm', ru: 'Сумки из спанбонда 80г/м² с логотипом', ro: 'Sacoșe nețesute Spunbond 80gsm cu logo', de: 'Vliesstoff-Einkaufstaschen 80g/m²', fr: 'Sacs cabas non-tissé Spunbond 80g/m²', ar: 'حقائب سبانبود القماشية الدعائية 80 جرام' } },
      { icon: '⚡', img: './assets/images/unused/product_116.jpeg', name: { en: 'Ultrasonic Heat Sealed Non-Woven Bags', ru: 'Сумки из спанбонда ультразвуковой пайкой', ro: 'Sacoșe nețesute lipite cu ultrasunete', de: 'Ultraschall-verschweißte Vliesstofftaschen', fr: 'Sacs non-tissé thermosoudés ultrasons', ar: 'حقائب سبانبود ملحومة بالحرارة فوق الصوتية' } },
      { icon: '👜', img: './assets/images/unused/product_117.jpeg', name: { en: 'Organic Cotton Canvas Shopper Bags 140gsm', ru: 'Эко-сумки из хлопка 140г/м²', ro: 'Sacoșe din bumbac organic 140gsm', de: 'Bio-Baumwoll-Canvas-Taschen 140g/m²', fr: 'Sacs cabas en coton bio 140g/m²', ar: 'حقائب تسوق قطنية 140 جرام' } },
      { icon: '💼', img: './assets/images/unused/product_118.png', name: { en: 'Heavy Duty Cotton Canvas Grocery Totes 280gsm', ru: 'Плотные сумки из холста 280г/м²', ro: 'Sacoșe groase din pânză bumbac 280gsm', de: 'Starke Baumwoll-Canvas-Shopper 280g/m²', fr: 'Sacs cabas épais en toile coton 280g/m²', ar: 'حقائب قماشية سميكة للأوزان 280 جرام' } },
      { icon: '✨', img: './assets/images/unused/product_119.jpeg', name: { en: 'Gloss Laminated Woven Promo Shoppers', ru: 'Ламинированные глянцевые промо-сумки', ro: 'Sacoșe promoționale laminate lucioase', de: 'Laminierte Glanz-Werbeshopper', fr: 'Sacs cabas publicitaires laminés brillants', ar: 'حقائب تسوق لامعة مطبوعة بحجم كبير' } },
      { icon: '🖤', img: './assets/images/unused/product_12.jpeg', name: { en: 'Matte Laminated Non-Woven Event Bags', ru: 'Матовые ламинированные промо-сумки', ro: 'Sacoșe promoționale laminate mate', de: 'Laminierte Matt-Werbeshopper', fr: 'Sacs cabas publicitaires laminés mats', ar: 'حقائب مطبوعة بطبقة مات عازلة' } },
      { icon: '🎒', img: './assets/images/unused/product_120.jpeg', name: { en: 'Drawstring Polyester Backpack Bags for Events', ru: 'Сумки-рюкзаки на затяжках для мероприятий', ro: 'Saci rucsac cu șnur pentru evenimente', de: 'Zugband-Rucksacktaschen für Events', fr: 'Sacs à dos à cordon pour événements', ar: 'حقائب ظهر برباط للمؤتمرات والفعاليات' } },
      { icon: '🔄', img: './assets/images/unused/product_121.jpeg', name: { en: 'Foldable Compact Nylon Shopping Pouches', ru: 'Складные нейлоновые сумки для покупок', ro: 'Sacoșe pliabile din nailon', de: 'Faltbare Nylon-Einkaufstaschen', fr: 'Sacs de shopping pliables en nylon', ar: 'حقائب تسوق من النايلون قابلة للطي' } },
      { icon: '🌿', img: './assets/images/unused/product_13.jpeg', name: { en: 'Jute & Burlap Natural Shopping Tote Bags', ru: 'Сумки для покупок из джута и мешковины', ro: 'Sacoșe din iută naturală', de: 'Natürliche Jute- & Sackleinen-Shopper', fr: 'Sacs cabas en jute naturelle', ar: 'حقائب تسوق من قماش الخيش والجوث الطبيعي' } },
      { icon: '♻️', img: './assets/images/unused/product_14.jpeg', name: { en: 'RPET Recycled Plastic Bottle Promo Shoppers', ru: 'Промо-сумки из переработанных пластиковых бутылок RPET', ro: 'Sacoșe promo din sticle plastic reciclate RPET', de: 'RPET Recycling-Plastikflaschen-Werbetaschen', fr: 'Sacs publicitaires en bouteilles plastique recyclées RPET', ar: 'حقائب تسوق مصنوعة من البلاستيك المعاد تدويره RPET' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '📦',
    img: './assets/images/unused/product_15.jpeg',
    chip: {
    ...
    products: [
      { icon: '🛍️', img: './assets/images/unused/product_16.jpeg', name: { en: 'High Density HDPE T-Shirt Grocery Bags', ru: 'Пакеты-майка ПНД высокой плотности', ro: 'Pungi maieu HDPE densitate mare', de: 'HDPE T-Shirt-Tragetaschen высокой плотности', fr: 'Sacs bretelles HDPE haute densité', ar: 'أكياس علاقية بولي إيثيلين عالية الكثافة' } },
      { icon: '🛍️', img: './assets/images/unused/product_17.jpeg', name: { en: 'Low Density LDPE Smooth T-Shirt Bags', ru: 'Пакеты-майка ПВД гладкие', ro: 'Pungi maieu LDPE finisaj neted', de: 'LDPE T-Shirt-Tragetaschen glatt', fr: 'Sacs bretelles LDPE finition lisse', ar: 'أكياس علاقية بولي إيثيلين ناعمة' } },
      { icon: '🛍️', img: './assets/images/unused/product_18.jpeg', name: { en: 'Heavy Duty PE Die-Cut Handle Shopping Bags', ru: 'Пакеты ПВД с вырубной усиленной ручкой', ro: 'Pungi PE cu mâner decupat ranforsat', de: 'PE-Grifflochbeutel verstärkt', fr: 'Sacs PE à poignées découpées renforcées', ar: 'أكياس بلاستيك بفتحات يد مقواة' } },
      { icon: '➰', img: './assets/images/unused/product_19.jpeg', name: { en: 'Flexible Loop Handle Polyethylene Bags', ru: 'Пакеты ПВД с петлевой ручкой', ro: 'Pungi PE cu mâner flexibil tip rigid', de: 'PE-Schlaufenhenkelbeutel', fr: 'Sacs PE à poignées boucles souples', ar: 'أكياس بلاستيك بمقابض شريطية' } },
      { icon: '🤐', img: './assets/images/unused/product_2.png', name: { en: 'Re-sealable Zip Lock Poly Bags (Various Sizes)', ru: 'Зип-пакеты ПВД с замком многоразовые', ro: 'Pungi PE cu fermoar ZIP reutilizabile', de: 'Wiederverschließbare PE-Druckverschlussbeutel', fr: 'Sacs PE à fermeture zip réutilisables', ar: 'أكياس بولي إيثيلين بسحاب إغلاق محكم' } },
      { icon: '🌀', img: './assets/images/unused/product_20.jpeg', name: { en: 'Hand Pallet Stretch Film Rolls 23 Micron', ru: 'Ручной стретч 23 микрон для обмотки паллет', ro: 'Folie stretch manuală 23 microni paleți', de: 'Hand-Stretchtfolie 23 Mikrometer', fr: 'Film étirable manuel 23 microns pour palettes', ar: 'رول تغليف استرتش يدوي للباليتات 23 ميكرون' } },
      { icon: '⚙️', img: './assets/images/unused/product_21.jpeg', name: { en: 'Machine Stretch Film Rolls 250% Pre-Stretch', ru: 'Машинный стретч 250% предрастяжение', ro: 'Folie stretch automată mașină 250%', de: 'Maschinen-Stretchfolie 250% Vordehnung', fr: 'Film étirable machine pré-étirage 250%', ar: 'رول استرتش آلي للباليتات شد 250%' } },
      { icon: '🗑️', img: './assets/images/unused/product_22.jpeg', name: { en: 'Black Heavy Duty Garbage Bags 120L/240L', ru: 'Плотные черные мешки для мусора 120л/240л', ro: 'Saci menajeri negri rezistenți 120L/240L', de: 'Schwarze Müllbeutel strapazierfähig 120L/240L', fr: 'Sacs poubelle noirs renforcés 120L/240L', ar: 'أكياس قمامة سوداء سميكة 120 و 240 لتر' } },
      { icon: '⚠️', img: './assets/images/unused/product_23.jpeg', name: { en: 'Medical Biohazard Waste Liners (Yellow/Red)', ru: 'Медицинские мешки для отходов (желтые/красные)', ro: 'Saci deșeuri medicale periculoase (galben/roșu)', de: 'Medizinische Abfallbeutel (Gelb/Rot)', fr: 'Sacs déchets médicaux infectieux (jaune/rouge)', ar: 'أكياس نفايات طبية خطرة صفراء وحمراء' } },
      { icon: '🔥', img: './assets/images/unused/product_24.jpeg', name: { en: 'PE Thermal Shrink Film Hoods for Pallets', ru: 'Термоусадочные колпаки ПВД для паллет', ro: 'Huse termocontractabile PE pentru paleți', de: 'PE-Thermoschrumpf-Hauben für Paletten', fr: 'Housses thermo-rétractables PE pour palettes', ar: 'أغطية بلاستيكية حرارية لتغليف الباليتات' } }
    ]
  },

  {
    ...
    group: 'hotel',
    icon: '🩴',
    img: './assets/images/unused/product_25.jpeg',
    chip: {
    ...
    products: [
      { icon: '🩴', img: './assets/images/unused/product_26.jpeg', name: { en: 'Custom Logo Velour Closed Toe Hotel Slippers', ru: 'Велюровые закрытые гостиничные тапочки с вышивкой', ro: 'Papuci hotelieri din pluș închiși cu broderie', de: 'Velours-Hotel-Slipper geschlossen mit Logo', fr: 'Chaussons d’hôtel velours fermés brodés', ar: 'شباشب وخفاف الفنادق المخملية المغلقة المطرزة' } },
      { icon: '🩴', img: './assets/images/unused/product_27.jpeg', name: { en: 'Waffle Weave Breathable Open Toe Slippers', ru: 'Вафельные дышащие тапочки с открытым носом', ro: 'Papuci hotelieri waffle respirabili deschiși', de: 'Waffel-Slipper atmungsaktiv offen', fr: 'Chaussons d’hôtel gaufres respirants ouverts', ar: 'شباشب قطن مجعد مفتوحة خفيفة للفنادق' } },
      { icon: '🧺', img: './assets/images/unused/product_28.jpeg', name: { en: 'Non-Woven Spunbond Laundry Bags with Drawstring', ru: 'Мешки для прачечной из спанбонда на завязках', ro: 'Saci spălătorie nețesuți cu șnur', de: 'Vliesstoff-Wäschebeutel mit Zugband', fr: 'Sacs à linge non-tissé avec cordon', ar: 'أكياس غسيل الملابس القماشية برباط' } },
      { icon: '🧺', img: './assets/images/unused/product_29.jpeg', name: { en: 'Organic Cotton Canvas Eco Laundry Bags', ru: 'Мешки для прачечной из натурального хлопка', ro: 'Saci spălătorie din bumbac organic', de: 'Bio-Baumwoll-Wäschebeutel', fr: 'Sacs à linge en coton bio canvas', ar: 'أكياس غسيل الملابس من القطن الطبيعي' } },
      { icon: '🧽', img: './assets/images/unused/product_3.png', name: { en: 'Shoe Shine Sponges in Custom Paper Box', ru: 'Губки для чистки обуви в брендированной коробке', ro: 'Bureți lustruit pantofi în cutie carton', de: 'Schuhputzschwämme in Pappschachtel', fr: 'Éponges à chaussures en boîte papier', ar: 'إسفنج تلميع الأحذية في علب كرتونية' } },
      { icon: '🧽', img: './assets/images/unused/product_30.jpeg', name: { en: 'Shoe Shine Polishing Mitts & Cloths', ru: 'Варежки и салфетки для полировки обуви', ro: 'Mănuși și lavete lustruit pantofi', de: 'Schuhputz-Handschuhe & Poliertücher', fr: 'Gants & chiffons à polir les chaussures', ar: 'قُفازات ومناشف تلميع الأحذية' } },
      { icon: '🧵', img: './assets/images/unused/product_31.jpeg', name: { en: 'Travel Sewing Kits in Custom Printed Box', ru: 'Швейные наборы для путешествий в коробочке', ro: 'Truse cusut voiaj în cutie personalizată', de: 'Reise-Nähzeuge in Schachtel mit Logo', fr: 'Kits de couture voyage en boîte personnalisée', ar: 'أطقم الخياطة الصغيرة للغرف والمستلزمات' } },
      { icon: '👔', img: './assets/images/unused/product_32.jpeg', name: { en: 'Velvet Anti-Slip Clothes Hangers with Clips', ru: 'Велюровые вешалки для одежды с зажимами', ro: 'Umerașe catifea antiderapante cu cleme', de: 'Samt Kleiderbügel anti-rutsch mit Klammern', fr: 'Cintres velours antidérapants avec pinces', ar: 'علاقات ملابس مخملية مع مشابك' } },
      { icon: '👔', img: './assets/images/unused/product_33.jpeg', name: { en: 'Solid Wooden Hotel Suit & Coat Hangers', ru: 'Деревянные вешалки для костюмов и пальто', ro: 'Umerașe din lemn masiv pentru costume', de: 'Massivholz-Hotelbügel für Anzüge', fr: 'Cintres en bois massif pour costumes', ar: 'علاقات ملابس خشبية صلبة للبدل' } },
      { icon: '🚪', img: './assets/images/unused/product_34.jpeg', name: { en: 'Hotel Room Do Not Disturb Door Hangers', ru: 'Таблички на дверь «Не беспокоить»', ro: 'Agățătoare ușă «Nu deranjați»', de: 'Türhänger «Bitte nicht stören»', fr: 'Accroche-portes «Ne pas déranger»', ar: 'بطاقات تعليق الأبواب رجاء عدم الإزعاج' } }
    ]
  },

  {
    ...
    group: 'hotel',
    icon: '🧴',
    img: './assets/images/unused/product_35.jpeg',
    chip: {
    ...
    products: [
      { icon: '🧴', img: './assets/images/unused/product_36.jpeg', name: { en: '30ml Hotel Nourishing Shampoo Bottles', ru: 'Мини-флаконы питательного шампуня 30мл', ro: 'Flacoane 30ml șampon hrănitor hotel', de: '30ml Pflegeshampoo Fläschchen', fr: 'Flacons 30ml shampooing nourrissant', ar: 'عبوات شامبو المغذي 30 مل للفنادق' } },
      { icon: '🧼', img: './assets/images/unused/product_37.jpeg', name: { en: '30ml Refreshing Shower Gel Bottles', ru: 'Гель для душа освежающий 30мл', ro: 'Gel de duș revigorant 30ml', de: '30ml Duschgel Fläschchen', fr: 'Flacons 30ml gel douche rafraîchissant', ar: 'عبوات جل الاستحمام 30 مل للفنادق' } },
      { icon: '🧴', img: './assets/images/unused/product_38.jpeg', name: { en: '30ml Hair Conditioner Bottles', ru: 'Кондиционер для волос 30мл', ro: 'Balsam de păr 30ml', de: '30ml Haarconditioner Fläschchen', fr: 'Flacons 30ml après-shampooing', ar: 'عبوات بلسم الشعر 30 مل' } },
      { icon: '🧴', img: './assets/images/unused/product_39.jpeg', name: { en: '30ml Moisturizing Body Lotion Bottles', ru: 'Увлажняющий лосьон для тела 30мл', ro: 'Loțiune hidratantă corp 30ml', de: '30ml Feuchtigkeits-Bodylotion', fr: 'Flacons 30ml lait hydratant corps', ar: 'عبوات لوشن مرطب للجسم 30 مل' } },
      { icon: '🧼', img: './assets/images/unused/product_4.png', name: { en: 'Pleated Paper Wrapped Soaps 20g', ru: 'Мыло в плиссе 20г с логотипом', ro: 'Săpun ambalat în hârtie pliabilă 20g', de: 'Plissierte Seifen 20g mit Logo', fr: 'Savons plissés 20g avec logo', ar: 'صابون مغلف ورق مطوي 20 جرام' } },
      { icon: '🧼', img: './assets/images/unused/product_40.jpeg', name: { en: 'Boxed Square Transparent Glycerin Soaps 25g', ru: 'Глицериновое прозрачное мыло в коробке 25г', ro: 'Săpun transparent din glicerină 25g', de: 'Glycerin-Seifen im Karton 25g', fr: 'Savons à la glycérine en boîte 25g', ar: 'صابون جليسرين شفاف مربع في كرتون 25 جرام' } },
      { icon: '🪥', img: './assets/images/unused/product_41.png', name: { en: 'Wheat Straw Eco Dental Kits (Brush + Paste)', ru: 'Зубные наборы из пшеничной соломы', ro: 'Truse dentare din paie de grâu (periuță + pastă)', de: 'Zahnpflege-Sets aus Weizenstroh', fr: 'Kits dentaires en paille de blé (brosse + dentifrice)', ar: 'أطقم العناية بالأسنان العضوية (فرشاة والمعجون)' } },
      { icon: '🪒', img: './assets/images/unused/product_42.jpeg', name: { en: 'Eco Shaving Kits (Razor + Shaving Cream Tube)', ru: 'Бритвенные наборы с станком и кремом', ro: 'Truse bărbierit (aparat + tub cremă)', de: 'Rasier-Sets (Rasierer + Creme-Tube)', fr: 'Kits de rasage (rasoir + tube crème)', ar: 'أطقم الحلاقة (ماكينة حلاقة مع أنبوب كريم)' } },
      { icon: '💅', img: './assets/images/unused/product_43.png', name: { en: 'Vanity Kits (Cotton Pads + Swabs + File)', ru: 'Косметические наборы (диски, палочки, пилочка)', ro: 'Truse cosmetice (dischete, bețișoare, pilă)', de: 'Kosmetik-Sets (Wattepads, Wattestäbchen, Feile)', fr: 'Kits beauté (cotons, cotons-tiges, lime)', ar: 'أطقم التجميل (قطن، نكاشات أذن، ومبرد)' } },
      { icon: '🚿', img: './assets/images/unused/product_44.jpeg', name: { en: 'Waterproof Shower Caps in Paper Box', ru: 'Шапочки для душа в бумажной коробке', ro: 'Scufii duș impermeabile în cutie carton', de: 'Duschhauben in Pappschachtel', fr: 'Charlottes de douche en boîte papier', ar: 'قبعات الاستحمام المعقمة في علب' } },
      { icon: '🚽', img: './assets/images/unused/product_45.png', name: { en: 'Sanitized Toilet Seat Paper Bands', ru: 'Бумажные полосы «Дезинфицировано» для унитазов', ro: 'Benzi hârtie dezinfectat pentru toaletă', de: 'Desinfizierte WC-Papierbänder', fr: 'Bandeaux papier désinfecté pour WC', ar: 'شرائط ورقية معقمة لمقاعد الحمامات' } },
      { icon: '🥂', img: './assets/images/unused/product_46.jpeg', name: { en: 'Hotel Room Glass Coasters & Covers', ru: 'Бумажные подставки и крышки для стаканов', ro: 'Suporturi și capace carton pentru pahare hotel', de: 'Glasuntersetzer & Becherabdeckungen', fr: 'Sous-verres & couvercles papier pour verres', ar: 'أغطية وقواعد أكواب ورقية مطبوعة للغرف' } }
    ]
  },

  {
    ...
    group: 'hotel',
    icon: '🧳',
    img: './assets/images/unused/product_47.jpeg',
    chip: {
...

  {
    ...
    group: 'hotel',
    icon: '🍽️',
    img: './assets/images/unused/product_57.jpeg',
    chip: {
...

  {
    ...
    group: 'hotel',
    icon: '🏊',
    img: './assets/images/unused/product_67.jpeg',
    chip: {
...

  {
    ...
    group: 'hotel',
    icon: '🛏️',
    img: './assets/images/unused/product_77.jpeg',
    chip: {
    ...
    products: [
      { icon: '🛏️', img: './assets/images/unused/product_78.jpeg', name: { en: 'Hotel Satin Stripe Bed Sheet Sets (300 TC)', ru: 'Комплекты белья из страйп-сатина 300 TC', ro: 'Seturi lenjerie pat satin cu dungi 300 TC', de: 'Hotel-Streifensatin-Bettwäsche 300 TC', fr: 'Parures de lit en satin rayé 300 TC', ar: 'أطقم ملاءات أسرّة ساتان مقلم 300 خيط' } },
      { icon: '🛏️', img: './assets/images/unused/product_79.jpeg', name: { en: 'Percale Plain White Hotel Bed Sheets (200 TC)', ru: 'Постельное белье из перкаля гладкое 200 TC', ro: 'Lenjerii pat din bumbac percale alb 200 TC', de: 'Glattweiße Perkal-Bettwäsche 200 TC', fr: 'Linge de lit en percale blanche 200 TC', ar: 'ملاءات أسرّة سادة بيضاء 200 خيط' } },
      { icon: '💤', img: './assets/images/unused/product_8.jpeg', name: { en: 'Hotel Pillowcases (Satin Stripe / Plain)', ru: 'Наволочки для гостиниц (страйп-сатин и гладкие)', ro: 'Fețe de pernă hotel (satin cu dungi și simplu)', de: 'Hotel-Kissenbezüge (Streifensatin & Glatt)', fr: 'Taies d’oreiller hôtel (satin rayé & uni)', ar: 'أغطية وسائد للفنادق (ساتان مقلم وسادة)' } },
      { icon: '🛀', img: './assets/images/unused/product_80.jpeg', name: { en: 'Heavy Commercial Bath Towels 600 GSM', ru: 'Плотные банные полотенца 600 г/м²', ro: 'Prosoape baie dense 600 GSM', de: 'Schwere Gewerbe-Handtücher 600 GSM', fr: 'Draps de bain denses 600 GSM', ar: 'مناشف حمام ثقيلة وممتازة 600 جرام' } },
      { icon: '🧼', img: './assets/images/unused/product_81.jpeg', name: { en: 'Hotel Hand Towels & Face Washcloths', ru: 'Полотенца для рук и салфетки для лица', ro: 'Prosoape mâini și fețe de masă hotel', de: 'Hotel Handtücher & Gesichtstücher', fr: 'Serviettes mains & débarbouillettes hôtel', ar: 'مناشف أيدي ومناشف وجة صغيرة للفنادق' } },
      { icon: '🦶', img: './assets/images/unused/product_82.jpeg', name: { en: 'Hotel Bath Mats 800 GSM Heavy Terry', ru: 'Коврики для ног в ванную 800 г/м²', ro: 'Covorașe baie din bumbac 800 GSM', de: 'Hotel Duschvorleger 800 GSM', fr: 'Tapis de bain denses 800 GSM', ar: 'دواسات ومفارش حمام ثقيلة 800 جرام' } },
      { icon: '🥋', img: './assets/images/unused/product_83.jpeg', name: { en: 'Plush Velour Bathrobes with Shawl Collar', ru: 'Махровые и велюровые халаты с шалевым воротником', ro: 'Halate baie pluș cu guler șal', de: 'Velours-Bademäntel mit Schalkragen', fr: 'Peignoirs de bain velours col chal', ar: 'أرواب حمام مخملية بياقة شال' } },
      { icon: '🥋', img: './assets/images/unused/product_84.jpeg', name: { en: 'Waffle Weave Lightweight Hotel Bathrobes', ru: 'Вафельные легкие халаты для отелей', ro: 'Halate baie ușoare din bumbac waffle', de: 'Leichte Waffel-Bademäntel für Hotels', fr: 'Peignoirs de bain légers gaufres', ar: 'أرواب حمام قطن مجعد خفيفة للفنادق' } },
      { icon: '🍽️', img: './assets/images/unused/product_85.jpeg', name: { en: 'Stain-Resistant Teflon Restaurant Tablecloths', ru: 'Скатерти для ресторанов с тефлоновой защитой от пятен', ro: 'Fețe de masă restaurant rezistente la pete cu teflon', de: 'Fleckenabweisende Teflon-Tischdecken', fr: 'Nappes de restaurant Téflon anti-taches', ar: 'مفارش طاولات مطاعم مع طلاء التفلون العازل' } },
      { icon: '🛏️', img: './assets/images/unused/product_86.jpeg', name: { en: 'Hotel Goose Down & Microfiber Pillows & Duvets', ru: 'Подушки и одеяла с гусиным пухом и микрофиброй', ro: 'Perne și pilote hotel din puf de gâscă și microfibră', de: 'Gänsedaunen- & Mikrofaser-Kissen & Betten', fr: 'Oreillers & couettes duvet d’oie & microfibre', ar: 'وسائد ولحف ريش النعام والميكروفيبر للفنادق' } }
    ]
  },

  {
    ...
    group: 'perfume',
    icon: '🧴',
    img: './assets/images/unused/product_87.jpeg',
    chip: {
