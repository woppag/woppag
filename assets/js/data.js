...
const CATS = [
  {
    ...
    group: 'packaging',
    icon: '🧂',
    img: './assets/images/claude_verified_v22/cat_0/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🧂', img: './assets/images/claude_verified_v22/cat_0/prod_1.jpg', name: { en: 'Portion Salt & Black Pepper Sachets', ru: 'Порционная соль и черный перец в саше', ro: 'Sare și piper negru porționat la plic', de: 'Portionssalz & Schwarzer Pfeffer', fr: 'Sel & Poivre noir en sachet portion', ar: 'ملح وفلفل أسود في عبوات فردية' } },
      { icon: '🍬', img: './assets/images/claude_verified_v22/cat_0/prod_10.jpg', name: { en: 'Portion White Sugar Sticks 4g', ru: 'Сахарные стики с логотипом 4г', ro: 'Plicuri de zahăr alb stick 4g', de: 'Weiße Zuckersticks mit Logo 4g', fr: 'Sticks de sucre blanc 4g avec logo', ar: 'أظرف سكر أبيض طولية 4 جرام' } },
      { icon: '🪵', img: './assets/images/claude_verified_v22/cat_0/prod_11.jpg', name: { en: 'Portion Brown Cane Sugar Sticks', ru: 'Тростниковый сахар в стиках с логотипом', ro: 'Plicuri de zahăr brun stick', de: 'Brauner Rohrzucker in Sticks', fr: 'Sticks de sucre roux de canne', ar: 'أظرف سكر بني قصب في عبوات' } },
      { icon: '🍅', img: './assets/images/claude_verified_v22/cat_0/prod_2.jpg', name: { en: 'Portion Ketchup Sachets 10g', ru: 'Порционный кетчуп в саше 10г', ro: 'Sos ketchup porționat 10g', de: 'Ketchup-Portionsbeutel 10g', fr: 'Sauce ketchup en sachet 10g', ar: 'صلصة كاتشب في أظرف 10 جرام' } },
      { icon: '🟡', img: './assets/images/claude_verified_v22/cat_0/prod_3.jpg', name: { en: 'Portion Mayonnaise & Mustard Sachets', ru: 'Порционный майонез и горчица в саше', ro: 'Maioneză și muștar porționat', de: 'Mayonnaise- & Senf-Portionsbeutel', fr: 'Mayonnaise & Moutarde en sachet', ar: 'مايونيز وخردل في أظرف فردية' } },
      { icon: '🥗', img: './assets/images/claude_verified_v22/cat_0/prod_4.jpg', name: { en: 'Portion Pomegranate Sauce & Vinegar', ru: 'Порционный гранатовый соус и уксус', ro: 'Sos de rodie și oțet porționat', de: 'Granatapfelsauce & Essig-Portionen', fr: 'Sauce grenade & Vinaigre en portion', ar: 'صلصة الرمان والخل في عبوات' } },
      { icon: '🫒', img: './assets/images/claude_verified_v22/cat_0/prod_5.jpg', name: { en: 'Portion Olive Oil & Salad Dressing', ru: 'Порционное оливковое масло и заправка', ro: 'Ulei de măsline porționat pentru salată', de: 'Olivenöl- & Salatdressing-Portionen', fr: 'Huile d’olive & Sauce salade en portion', ar: 'زيت زيتون وتتبيلة سلطة في عبوات' } },
      { icon: '☕', img: './assets/images/claude_verified_v22/cat_0/prod_6.jpg', name: { en: 'Portion Instant 3-in-1 Coffee Sticks', ru: 'Растворимый кофе 3 в 1 в стиках', ro: 'Cafea instant 3 în 1 la stick', de: 'Instant-Kaffee 3-in-1 Sticks', fr: 'Café instantané 3-en-1 en stick', ar: 'قهوة سريعة التحضير 3 في 1' } },
      { icon: '🍵', img: './assets/images/claude_verified_v22/cat_0/prod_7.jpg', name: { en: 'Portion Black Tea & Green Tea Bags', ru: 'Порционный черный и зеленый чай', ro: 'Pliculețe ceai negru și verde', de: 'Schwarz- & Grüntee-Portionsbeutel', fr: 'Sachets de thé noir & vert', ar: 'أكياس شاي أسود وأخضر فردية' } },
      { icon: '🍯', img: './assets/images/claude_verified_v22/cat_0/prod_8.jpg', name: { en: 'Portion Honey Containers 20g', ru: 'Порционный натуральный мед 20г', ro: 'Miere naturală porționată 20g', de: 'Portionshonig 20g', fr: 'Miel naturel en pot individuel 20g', ar: 'عسل طبيعي في عبوات صغيرة 20 جرام' } },
      { icon: '🍓', img: './assets/images/claude_verified_v22/cat_0/prod_9.jpg', name: { en: 'Portion Strawberry & Cherry Jam Cups', ru: 'Порционный клубничный и вишневый джем', ro: 'Gem de căpșuni și vișine porționat', de: 'Erdbeer- & Kirschmarmelade Portionen', fr: 'Confiture fraise & cerise en pot 20g', ar: 'مربى فراولة وكرز في عبوات صغيرة' } },
      { icon: '🍫', img: './assets/images/claude_verified_v22/cat_0/prod_1.jpg', name: { en: 'Portion Hazelnut Chocolate Cream Cups', ru: 'Порционная шоколадно-ореховая паста', ro: 'Cremă de ciocolată cu alune porționată', de: 'Nuss-Nugat-Creme Portionsbecher', fr: 'Pâte à tartiner chocolat noisette 20g', ar: 'شوكولاتة بندق في عبوات صغيرة' } }
    ]
  },

  {
    ...
    group: 'confectionery',
    icon: '🎂',
    img: './assets/images/claude_verified_v22/cat_1/header.jpg',
    chip: {
    ...
    products: [
      { icon: '📦', img: './assets/images/claude_verified_v22/cat_1/prod_1.jpg', name: { en: 'Square Window Cake Boxes 25x25cm', ru: 'Квадратные коробки для тортов с окном', ro: 'Cutii pătrate pentru tort cu fereastră', de: 'Quadratische Tortenboxen mit Fenster', fr: 'Boîtes à gâteaux carrées avec fenêtre', ar: 'علب كعك مربعة مع نافذة شفافة' } },
      { icon: '🎂', img: './assets/images/claude_verified_v22/cat_1/prod_2.jpg', name: { en: 'Tall Layer Cake Boxes with Handle', ru: 'Высокие коробки для многоярусных тортов', ro: 'Cutii înalte pentru torturi supraetajate', de: 'Hohe Etagentorten-Boxen mit Griff', fr: 'Boîtes hautes pour gâteaux à étages', ar: 'علب كعك طبقات مرتفعة بمقبض' } },
      { icon: '🪙', img: './assets/images/claude_verified_v22/cat_1/prod_3.jpg', name: { en: 'Gold Round Cake Boards 3mm', ru: 'Золотые круглые подложки для тортов 3мм', ro: 'Discuri aurii rotunde pentru tort 3mm', de: 'Goldene runde Tortenretter 3mm', fr: 'Supports gâteaux rond Or 3mm', ar: 'أطباق كيك دائرية ذهبية 3 مم' } },
      { icon: '🥈', img: './assets/images/claude_verified_v22/cat_1/prod_4.jpg', name: { en: 'Silver Square Cake Boards 4mm', ru: 'Серебряные квадратные подложки 4мм', ro: 'Discuri argintii pătrate 4mm', de: 'Silberne quadratische Tortenplatten 4mm', fr: 'Supports carrés Argent 4mm', ar: 'أطباق كيك مربعة فضية 4 مم' } },
      { icon: '📜', img: './assets/images/claude_verified_v22/cat_1/prod_5.jpg', name: { en: 'Siliconized Baking Parchment Rolls', ru: 'Пергаментная бумага в рулонах для выпечки', ro: 'Hârtie de copt siliconată rola', de: 'Silikonisierte Backpapier-Rollen', fr: 'Rouleaux papier cuisson siliconé', ar: 'ورق الخبز بالفرن المغلف بالسيليكون' } },
      { icon: '🧁', img: './assets/images/claude_verified_v22/cat_1/prod_6.jpg', name: { en: 'Disposable Heavy Duty Piping Bags 18 Inch', ru: 'Кондитерские мешки повышенной прочности 18"', ro: 'Poșuri de unică folosință rezistente 18"', de: 'Einweg-Spritzbeutel extra stark 18"', fr: 'Poches à douille jetables renforcées 18"', ar: 'أكياس تزيين الكيك سميكة 18 بوصة' } },
      { icon: '🧁', img: './assets/images/claude_verified_v22/cat_1/prod_7.jpg', name: { en: 'Stainless Steel Pastry Nozzles Set', ru: 'Наборы стальных кондитерских насадок', ro: 'Set duiuri patiserie din inox', de: 'Edelstahl Tüllen-Set für Gebäck', fr: 'Kits douilles à pâtisserie en inox', ar: 'طقم أقماع وتزيين الحلويات الستانلس' } },
      { icon: '🧁', img: './assets/images/claude_verified_v22/cat_1/prod_8.jpg', name: { en: 'Cupcake Boxes with 6-Hole Inserts', ru: 'Коробки для капкейков на 6 ячеек', ro: 'Cutii cupcakes cu inserție 6 locuri', de: 'Cupcake-Boxen mit 6er Inlay', fr: 'Boîtes pour 6 cupcakes avec calage', ar: 'علب الكب كيك 6 خانات' } },
      { icon: '🍬', img: './assets/images/claude_verified_v22/cat_1/prod_9.jpg', name: { en: 'Macaron Window Gift Boxes', ru: 'Подарочные коробки для макаронс с окном', ro: 'Cutii cadou macarons cu fereastră', de: 'Macaron-Geschenkboxen mit Fenster', fr: 'Boîtes cadeaux pour macarons avec fenêtre', ar: 'علب هدايا الماكرون الفرنسية' } },
      { icon: '🍰', img: './assets/images/claude_verified_v22/cat_1/prod_1.jpg', name: { en: 'Transparent Monoport Dessert Boxes', ru: 'Прозрачные коробки для десертов монопорций', ro: 'Cutii transparente monoporție desert', de: 'Transparente Einzeldessert-Boxen', fr: 'Boîtes transparentes pour desserts individuels', ar: 'علب الحلويات والحلويات الفردية الشفافة' } },
      { icon: '🍫', img: './assets/images/claude_verified_v22/cat_1/prod_2.jpg', name: { en: 'Chocolate & Truffle Gift Boxes', ru: 'Коробки для конфет и трюфелей', ro: 'Cutii cadou ciocolată și trufe', de: 'Schokoladen- & Trüffel-Geschenkboxen', fr: 'Boîtes cadeaux pour chocolats & truffes', ar: 'علب شوكولاتة وترافل فاخرة' } },
      { icon: '🥐', img: './assets/images/claude_verified_v22/cat_1/prod_3.jpg', name: { en: 'Bakery Pie & Tart Cardboard Boxes', ru: 'Картонные коробки для пирогов и тартов', ro: 'Cutii carton pentru tarte și plăcinte', de: 'Kartonboxen für Kuchen & Tarten', fr: 'Boîtes carton pour tartes & quiches', ar: 'علب كرتون للمخبوزات والفطائر' } }
    ]
  },

  {
    ...
    group: 'food',
    icon: '🌾',
    img: './assets/images/claude_verified_v22/cat_2/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🍯', img: './assets/images/claude_verified_v22/cat_2/prod_1.jpg', name: { en: 'Portion Natural Honey 20g Jars', ru: 'Порционный натуральный мед в стекле 20г', ro: 'Miere naturală porționată la borcan 20g', de: 'Portionshonig 20g Gläser', fr: 'Miel naturel en petit pot verre 20g', ar: 'عسل طبيعي في برطمانات زجاجية 20 جرام' } },
      { icon: '🍓', img: './assets/images/claude_verified_v22/cat_2/prod_2.jpg', name: { en: 'Portion Strawberry Jam 20g Cups', ru: 'Порционный клубничный джем 20г', ro: 'Gem de căpșuni porționat 20g', de: 'Erdbeermarmelade Portionsbecher 20g', fr: 'Confiture de fraise en barquette 20g', ar: 'مربى فراولة في عبوات 20 جرام' } },
      { icon: '🍬', img: './assets/images/claude_verified_v22/cat_2/prod_3.jpg', name: { en: 'Refined White Sugar ICUMSA 45 (25kg)', ru: 'Белый сахар ICUMSA 45 в мешках 25кг', ro: 'Zahăr rafinat alb ICUMSA 45 (25kg)', de: 'Raffinierter weißer Zucker ICUMSA 45 (25kg)', fr: 'Sucre blanc raffiné ICUMSA 45 (25kg)', ar: 'سكر أبيض مكرر ICUMSA 45 أكياس 25 كجم' } },
      { icon: '🪵', img: './assets/images/claude_verified_v22/cat_2/prod_4.jpg', name: { en: 'Brown Cane Sugar Bulk 25kg', ru: 'Тростниковый сахар оптом 25кг', ro: 'Zahăr brun din trestie angro 25kg', de: 'Brauner Rohrzucker in 25kg Säcken', fr: 'Sucre roux de canne en sacs de 25kg', ar: 'سكر بني قصب السكر بالجملة 25 كجم' } },
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_2/prod_5.jpg', name: { en: 'Refined Sunflower Cooking Oil 5L', ru: 'Подсолнечное масло 5л канистры', ro: 'Ulei rafinat floarea soarelui 5L', de: 'Raffiniertes Sonnenblumenöl 5L', fr: 'Huile de tournesol raffinée 5L', ar: 'زيت عباد الشمس المكرر عبوات 5 لتر' } },
      { icon: '🫒', img: './assets/images/claude_verified_v22/cat_2/prod_6.jpg', name: { en: 'Extra Virgin Olive Oil Bulk 18L Tin', ru: 'Оливковое масло Extra Virgin 18л', ro: 'Ulei de măsline extravirgin 18L', de: 'Natives Olivenöl Extra 18L Kanister', fr: 'Huile d’olive extra vierge 18L', ar: 'زيت زيتون بكر ممتاز صفيح 18 لتر' } },
      { icon: '🧂', img: './assets/images/claude_verified_v22/cat_2/prod_7.jpg', name: { en: 'Ground Black Pepper Bulk 1kg', ru: 'Молотый черный перец 1кг', ro: 'Piper negru măcinat 1kg', de: 'Gemahlener schwarzer Pfeffer 1kg', fr: 'Poivre noir moulu en sac 1kg', ar: 'فلفل أسود مطحون عبوة 1 كجم' } },
      { icon: '🧂', img: './assets/images/claude_verified_v22/cat_2/prod_1.jpg', name: { en: 'Iodized Food Grade Table Salt 25kg', ru: 'Пищевая йодированная соль 25кг', ro: 'Sare iodată alimentară 25kg', de: 'Jodiertes Speisesalz 25kg', fr: 'Sel de table iodé alimentaire 25kg', ar: 'ملح طعام يودي 25 كجم' } },
      { icon: '🌶️', img: './assets/images/claude_verified_v22/cat_2/prod_2.jpg', name: { en: 'Red Pepper Flakes & Sweet Paprika', ru: 'Сушеный красный перец и паприка', ro: 'Fulg de ardei roșu și boia dulce', de: 'Chiliflocken & Süße Paprika', fr: 'Piment en flocons & Paprika doux', ar: 'رقائق الفلفل الأحمر والبابريكا الحلوة' } },
      { icon: '🌿', img: './assets/images/claude_verified_v22/cat_2/prod_3.jpg', name: { en: 'Culinary Oregano & Thyme Bulk', ru: 'Орегано и тимьян сушеный оптом', ro: 'Oregano și cimbru uscat angro', de: 'Oregano & Thymian in Großmengen', fr: 'Origan & Thyme séché en gros', ar: 'أوريغانو وزعتر مجفف بالجملة' } },
      { icon: '🌾', img: './assets/images/claude_verified_v22/cat_2/prod_4.jpg', name: { en: 'Long Grain Basmati Rice 25kg Bags', ru: 'Рис Басмати длиннозерный 25кг', ro: 'Orez Basmati cu bob lung 25kg', de: 'Langkorn-Basmati-Reis 25kg Säcke', fr: 'Riz Basmati grain long sacs 25kg', ar: 'أرز بسمتي طويل الحبة أكياس 25 كجم' } },
      { icon: '🫘', img: './assets/images/claude_verified_v22/cat_2/prod_5.jpg', name: { en: 'Red & Green Lentils Bulk 25kg', ru: 'Красная и зеленая чечевица оптом 25кг', ro: 'Linte roșie și verde angro 25kg', de: 'Rote & Grüne Linsen in 25kg Säcken', fr: 'Lentilles rouges & vertes en sacs 25kg', ar: 'عدس أحمر وأخضر بالجملة 25 كجم' } }
    ]
  },

  {
    ...
    group: 'cleaning',
    icon: '🧼',
    img: './assets/images/claude_verified_v22/cat_3/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_3/prod_1.jpg', name: { en: 'Concentrated Lemon Dishwashing Liquid 5L', ru: 'Концентрат для мытья посуды Лимон 5л', ro: 'Detergent concentrat vase Lămâie 5L', de: 'Konzentriertes Zitrone Spülmittel 5L', fr: 'Liquide vaisselle concentré citron 5L', ar: 'سائل غسيل الأطباق بالليمون مركز 5 لتر' } },
      { icon: '🍽️', img: './assets/images/claude_verified_v22/cat_3/prod_10.jpg', name: { en: 'Commercial Dishwasher Rinse Aid 10L', ru: 'Ополаскиватель для посудомоечных машин 10л', ro: 'Lichid clătire mașină spălat vase 10L', de: 'Klarspüler für gewerbliche Spülmaschinen 10L', fr: 'Liquide de rinçage vaisselle pro 10L', ar: 'مساعد شطف غسالات الأطباق الصناعية 10 لتر' } },
      { icon: '🧽', img: './assets/images/claude_verified_v22/cat_3/prod_11.jpg', name: { en: 'Floor Disinfectant Lavender 5L', ru: 'Дезинфицирующее средство для полов Лаванда 5л', ro: 'Dezinfectant pardoseli Levănțică 5L', de: 'Bodendesinfektionsmittel Lavendel 5L', fr: 'Désinfectant sols lavande 5L', ar: 'مطهر ومعطر أرضيات باللافندر 5 لتر' } },
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_3/prod_2.jpg', name: { en: 'Surface Sanitizer Spray 750ml', ru: 'Спрей дезинфекция поверхностей 750мл', ro: 'Spray dezinfectant suprafețe 750ml', de: 'Flächendesinfektionsspray 750ml', fr: 'Désinfectant surfaces spray 750ml', ar: 'بخاخ تعقيم الأسطح 750 مل' } },
      { icon: '🧺', img: './assets/images/claude_verified_v22/cat_3/prod_3.jpg', name: { en: 'Industrial Laundry Powder Detergent 20kg', ru: 'Стиральный порошок для прачечных 20кг', ro: 'Detergent pudră spălătorie industrială 20kg', de: 'Industrielles Waschpulver 20kg', fr: 'Lessive poudre industrielle 20kg', ar: 'مسحوق غسيل صناعي للمغاسل 20 كجم' } },
      { icon: '🌸', img: './assets/images/claude_verified_v22/cat_3/prod_4.jpg', name: { en: 'Fabric Softener & Conditioner 10L', ru: 'Кондиционер для белья 10л', ro: 'Balsam rufe concentrat 10L', de: 'Weichspüler & Konditionierer 10L', fr: 'Adoucissant & assouplissant textile 10L', ar: 'معطر ومنعم ملابس مركز 10 لتر' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_3/prod_5.jpg', name: { en: 'Antibacterial Liquid Hand Soap 5L', ru: 'Антибактериальное жидкое мыло 5л', ro: 'Săpun lichid antibacterian 5L', de: 'Antibakterielle Flüssighandseife 5L', fr: 'Savon liquide antibactérien 5L', ar: 'صابون أيدي سائل مضاد للبكتيريا 5 لتر' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_3/prod_6.jpg', name: { en: 'Foam Hand Soap Refill Canister 5L', ru: 'Пенное мыло для рук канистра 5л', ro: 'Spumă săpun mâini rezerve 5L', de: 'Schaumseife-Nachfüllung 5L', fr: 'Recharge savon mousse 5L', ar: 'صابون رغوة سائل عبوة 5 لتر' } },
      { icon: '🪟', img: './assets/images/claude_verified_v22/cat_3/prod_7.jpg', name: { en: 'Glass & Mirror Cleaner Spray 750ml', ru: 'Средство для стекол и зеркал 750мл', ro: 'Detergent geamuri și oglinzi 750ml', de: 'Glas- & Spiegelreiniger Spray 750ml', fr: 'Nettoyant vitres & miroirs 750ml', ar: 'منظف وملمع الزجاج والمرايا 750 مل' } },
      { icon: '🍳', img: './assets/images/claude_verified_v22/cat_3/prod_8.jpg', name: { en: 'Heavy Duty Kitchen Degreaser 5L', ru: 'Средство от жира на кухне 5л', ro: 'Degresant bucătărie profesional 5L', de: 'Starker Küchenentfetter 5L', fr: 'Dégraissant cuisine puissant 5L', ar: 'منظف ومزيل دهون المطابخ الثقيلة 5 لتر' } },
      { icon: '🧪', img: './assets/images/claude_verified_v22/cat_3/prod_9.jpg', name: { en: 'Chlorinated Bleach Sanitizer 5L', ru: 'Хлорный отбеливатель и дезинфектант 5л', ro: 'Inălbitor clorurat dezinfectant 5L', de: 'Chlor-Bleich- & Desinfektionsmittel 5L', fr: 'Eau de Javel désinfectante 5L', ar: 'مبيض ومطهر كلور مركز 5 لتر' } },
      { icon: '🚽', img: './assets/images/claude_verified_v22/cat_3/prod_1.jpg', name: { en: 'Toilet Bowl Cleaner Acid Gel 1L', ru: 'Гель для чистки унитазов 1л', ro: 'Gel acid curățare toaletă 1L', de: 'Säure-WC-Reiniger Gel 1L', fr: 'Gel nettoyant WC acide 1L', ar: 'جل تنظيف وتعقيم الحمامات 1 لتر' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🌿',
    img: './assets/images/claude_verified_v22/cat_4/header.png',
    chip: {
    ...
    products: [
      { icon: '☕', img: './assets/images/claude_verified_v22/cat_4/prod_1.png', name: { en: 'Valved Roasted Coffee Bean Doypack 250g', ru: 'Пакеты для кофе с клапаном 250г', ro: 'Pungi cafea cu supapă 250g', de: 'Kaffeebeutel mit Ventil 250g', fr: 'Sachets café avec valve 250g', ar: 'أكياس لحفظ البن المزودة بصمام 250 جرام' } },
      { icon: '🫘', img: './assets/images/claude_verified_v22/cat_4/prod_2.jpg', name: { en: 'Rectangular Window Kraft Doypack 500g', ru: 'Крафт дойпак с прямоугольным окном 500г', ro: 'Pungi Doypack kraft cu fereastră dreptunghiulară', de: 'Rechteckfenster Kraft Doypack 500g', fr: 'Sachets Doypack kraft fenêtre rectangulaire', ar: 'أكياس كرافت مع نافذة مستطيلة 500 جرام' } },
      { icon: '🥜', img: './assets/images/claude_verified_v22/cat_4/prod_3.jpg', name: { en: 'Oval Window Stand-Up Kraft Pouch', ru: 'Крафт дойпак с овальным окном', ro: 'Pungi Doypack kraft cu fereastră ovală', de: 'Ovalfenster Kraft Stehbeutel', fr: 'Sachets kraft fenêtre ovale', ar: 'أكياس كرافت وقوفية نافذة بيضاوية' } },
      { icon: '✨', img: './assets/images/claude_verified_v22/cat_4/prod_4.png', name: { en: 'Full Transparent Front Kraft Back Doypack', ru: 'Дойпак с прозрачным фасадом и крафт спинкой', ro: 'Pungi Doypack fața transparentă spate kraft', de: 'Transparente Front Kraft-Rücken Doypack', fr: 'Doypack face transparente dos kraft', ar: 'أكياس كرافت جانب شفاف بالكامل' } },
      { icon: '🖤', img: './assets/images/claude_verified_v22/cat_4/prod_5.png', name: { en: 'Matte Black Aluminum Barrier Zip Pouch', ru: 'Матовые черные дойпаки с фольгой', ro: 'Pungi Doypack negru mat cu aluminiu', de: 'Mattschwarze Alu-Barriere-Zip-Beutel', fr: 'Sachets noir mat barrière alu zip', ar: 'أكياس دوي باك سوداء فاخرة مع سحاب' } },
      { icon: '🤍', img: './assets/images/claude_verified_v22/cat_4/prod_6.jpg', name: { en: 'Matte White Aluminum Foil Doypack', ru: 'Матовые белые фольгированные дойпаки', ro: 'Pungi Doypack alb mat cu aluminiu', de: 'Mattweiße Alu-Barriere-Zip-Beutel', fr: 'Sachets blanc mat barrière alu zip', ar: 'أكياس دوي باك بيضاء مع عازل ألومنيوم' } },
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_4/prod_7.jpg', name: { en: 'Kraft Pouch with Liquid Spout & Cap', ru: 'Крафт дойпак с носиком-дозатором', ro: 'Pungi kraft cu dop pentru lichide', de: 'Kraft-Standbeutel mit Ausgießer & Kappe', fr: 'Sachet kraft avec bouchon verseur', ar: 'أكياس كرافت وقوفية مع صنبور صب' } },
      { icon: '🪙', img: './assets/images/claude_verified_v22/cat_4/prod_8.jpg', name: { en: 'Metallic Silver Vacuum Zip Pouch', ru: 'Серебряные вакуумные дойпаки', ro: 'Pungi argintii metalizate cu fermoar', de: 'Silberne Metall-Vakuum-Zip-Beutel', fr: 'Sachets sous vide argentés avec zip', ar: 'أكياس تفريغ الهواء الفضية مع سحاب' } },
      { icon: '🌱', img: './assets/images/claude_verified_v22/cat_4/prod_9.jpg', name: { en: 'Eco Compostable PLA Barrier Zip Bag', ru: 'Биоразлагаемые дойпаки из PLA', ro: 'Pungi bio compostabile PLA cu fermoar', de: 'Kompostierbare PLA Barriere-Zip-Beutel', fr: 'Sachets compostables PLA barrière zip', ar: 'أكياس دوي باك عضوية قابلة للتحلل' } },
      { icon: '☕', img: './assets/images/claude_verified_v22/cat_4/prod_1.png', name: { en: 'Side Gusseted Coffee Valve Bag 1kg', ru: 'Пакеты для кофе с фальцами и клапаном 1кг', ro: 'Pungi cafea pliu lateral cu supapă 1kg', de: 'Seitenfalten-Kaffeebeutel mit Ventil 1kg', fr: 'Sachets café soufflets latéraux valve 1kg', ar: 'أكياس بن بطيات جانبية وصمام 1 كجم' } },
      { icon: '📦', img: './assets/images/claude_verified_v22/cat_4/prod_2.jpg', name: { en: 'Flat Bottom Quad Seal Box Pouch', ru: 'Пакеты с плоским дном 4-х шовные', ro: 'Pungi cu fund plat 4 sigilii', de: 'Flachboden-Standbeutel mit 4 Nähten', fr: 'Sachets fond plat 4 soudures', ar: 'أكياس قاع مسطح أربعة لحامات' } },
      { icon: '🌰', img: './assets/images/claude_verified_v22/cat_4/prod_3.jpg', name: { en: 'Dried Fruit & Nuts Kraft Window Pouch', ru: 'Крафт пакеты для сухофруктов и орехов', ro: 'Pungi kraft pentru fructe uscate și alune', de: 'Kraftbeutel für Trockenfrüchte & Nüsse', fr: 'Sachets kraft pour fruits secs & noix', ar: 'أكياس كرافت للمكسرات والفواكه المجففة' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🛍️',
    img: './assets/images/claude_verified_v22/cat_5/header.jpg',
    chip: {
...

  {
    ...
    group: 'packaging',
    icon: '🧻',
    img: './assets/images/claude_verified_v22/cat_6/header.jpg',
    chip: {
    ...
    products: [
      { icon: '💧', img: './assets/images/claude_verified_v22/cat_6/prod_1.jpg', name: { en: 'Single Sachet Refreshing Wet Wipes 6x8cm', ru: 'Влажные салфетки в саше 6х8см с логотипом', ro: 'Șervețele umede la plic 6x8cm cu logo', de: 'Erfrischungstücher im Sachet 6x8cm', fr: 'Lingettes rince-doigts individuelles 6x8cm', ar: 'مناديل مبللة معطرة في أظرف 6x8 سم' } },
      { icon: '💧', img: './assets/images/claude_verified_v22/cat_6/prod_2.jpg', name: { en: 'Large Sachet Wet Wipes 7x12cm', ru: 'Влажные салфетки большого формата 7х12см', ro: 'Șervețele umede format mare 7x12cm', de: 'Große Erfrischungstücher 7x12cm', fr: 'Lingettes rafraîchissantes grand format 7x12cm', ar: 'مناديل مبللة حجك كبير 7x12 سم' } },
      { icon: '✈️', img: './assets/images/claude_verified_v22/cat_6/prod_3.jpg', name: { en: 'Airline & Hotel Hot/Cold Refreshing Towels', ru: 'Освежающие махровые полотенца для авиалиний', ro: 'Prosoape umede calde/reci pentru linii aeriene', de: 'Heiße/Kalte Erfrischungstücher für Airlines', fr: 'Serviettes rafraîchissantes chaudes/froides airlines', ar: 'مناشف حارة/باردة معطرة للطيران والفنادق' } },
      { icon: '🛡️', img: './assets/images/claude_verified_v22/cat_6/prod_4.jpg', name: { en: 'Alcohol-Free Antimicrobial Sanitizing Wipes', ru: 'Антибактериальные салфетки без спирта', ro: 'Șervețele dezinfectante fără alcool', de: 'Alkoholfreie antibakterielle Feuchttücher', fr: 'Lingettes désinfectantes sans alcool', ar: 'مناديل معقمة خالية من الكحول' } },
      { icon: '🧻', img: './assets/images/claude_verified_v22/cat_6/prod_5.jpg', name: { en: 'Dispenser Refill Napkins (1/4 Fold)', ru: 'Салфетки для диспенсеров 1/4 сложения', ro: 'Rezerve șervețele dispenser 1/4 împăturite', de: 'Spenderservietten-Nachfüllung 1/4 Falz', fr: 'Serviettes pour distributeur pliage 1/4', ar: 'مناديل لموزعات المناديل طية 1/4' } },
      { icon: '🍸', img: './assets/images/claude_verified_v22/cat_6/prod_6.jpg', name: { en: 'Cocktail Paper Napkins 2-Ply 24x24cm', ru: 'Коктейльные салфетки 2 слоя 24х24см', ro: 'Șervețele cocktail 2 straturi 24x24cm', de: 'Cocktail-Servietten 2-lagig 24x24cm', fr: 'Serviettes cocktail 2 plis 24x24cm', ar: 'مناديل كوكتيل طبقتين 24x24 سم' } },
      { icon: '🍽️', img: './assets/images/claude_verified_v22/cat_6/prod_7.jpg', name: { en: 'Dinner Paper Napkins 2-Ply 33x33cm', ru: 'Столовые салфетки 2 слоя 33х33см', ro: 'Șervețele masă 2 straturi 33x33cm', de: 'Mahlzeit-Servietten 2-lagig 33x33cm', fr: 'Serviettes de table 2 plis 33x33cm', ar: 'مناديل طعام طبقتين 33x33 سم' } },
...

  {
    ...
    group: 'packaging',
    icon: '🍴',
    img: './assets/images/claude_verified_v22/cat_7/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '🍦', img: './assets/images/claude_verified_v22/cat_7/prod_4.jpg', name: { en: 'Disposable Wooden Ice Cream Spoons', ru: 'Деревянные ложечки для мороженого', ro: 'Lingurițe din lemn pentru înghețată', de: 'Einweg-Holzeislöffel', fr: 'Petites cuillères en bois pour glace', ar: 'ملاعق خشبية صغيرة للآيس كريم' } },
...

  {
    ...
    group: 'packaging',
    icon: '📜',
    img: './assets/images/claude_verified_v22/cat_8/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '❄️', img: './assets/images/claude_verified_v22/cat_8/prod_2.jpg', name: { en: 'Poly-Coated Freezer Paper Sheets', ru: 'Бумага с полимерным слоем для заморозки', ro: 'Hârtie laminată pentru congelare', de: 'Poly-beschichtetes Gefrierpapier', fr: 'Papier plastifié pour congélation', ar: 'ورق مقوى مغلف للتجميد بحفظ اللحوم' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🍱',
    img: './assets/images/claude_verified_v22/cat_9/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🍣', img: './assets/images/claude_verified_v22/cat_9/prod_1.jpg', name: { en: 'Anti-Fog Bento Sushi Trays (Small)', ru: 'Контейнеры для суши маленькие с крышкой anti-fog', ro: 'Caserole sushi mici cu capac anti-aburire', de: 'Anti-Beschlag Sushi Bento Trays Klein', fr: 'Barquettes sushi bento anti-buée small', ar: 'عبوات سوشي بينتو حجم صغير' } },
      { icon: '🍱', img: './assets/images/claude_verified_v22/cat_9/prod_2.jpg', name: { en: 'Large Party Size Sushi Platter Trays', ru: 'Большие подносы для сет-наборов суши', ro: 'Tăvi mari Sushi Party Platter', de: 'Große Party-Sushi-Platten', fr: 'Plateaux repas sushi taille party', ar: 'أطباق سوشي حجم عائلي وكبير' } },
      { icon: '🥢', img: './assets/images/claude_verified_v22/cat_9/prod_3.jpg', name: { en: 'Bamboo Chopsticks in Printed Sleeves', ru: 'Бамбуковые палочки в бумажной упаковке', ro: 'Bețișoare bambus în plic ambalat', de: 'Bambus-Essstäbchen in bedruckter Hülle', fr: 'Baguettes en bambou en étui papier imprimé', ar: 'عيدان أكل الخيزران في أظرف ورقية' } },
      { icon: '🐟', img: './assets/images/claude_verified_v22/cat_9/prod_4.jpg', name: { en: 'Soy Sauce Fish Bottles 8ml & 15ml', ru: 'Бутылочки «рыбки» для соевого соуса 8мл и 15мл', ro: 'Sticluțe peștișor sos soia 8ml și 15ml', de: 'Sojasaucen-Fischfläschchen 8ml & 15ml', fr: 'Flacons poisson pour sauce soja 8ml & 15ml', ar: 'عبوات صويا صوص شكل سمكة 8 و 15 مل' } },
      { icon: '🍜', img: './assets/images/claude_verified_v22/cat_9/prod_1.jpg', name: { en: 'Round Kraft Wok & Noodle Boxes', ru: 'Круглые коробочки для лапши вок', ro: 'Cutii rotunde pentru tăieței wok', de: 'Runde Wok-Nudelboxen', fr: 'Boîtes rondes pour nouilles wok', ar: 'علب نودلز ووك كرافت دائرية' } },
      { icon: '🍲', img: './assets/images/claude_verified_v22/cat_9/prod_2.jpg', name: { en: 'Leak-Proof Ramen Soup Bowls with Lids', ru: 'Герметичные миски для рамэна и супов', ro: 'Boluri etanșe pentru supe și ramen', de: 'Auslaufsichere Schalen für Ramen-Suppen', fr: 'Bols étanches pour soupes ramen', ar: 'أوعية شوربة الرامن محكمة الإغلاق' } },
      { icon: '🍙', img: './assets/images/claude_verified_v22/cat_9/prod_3.jpg', name: { en: 'Triangular Onigiri Rice Ball Wrapping Film', ru: 'Пленка для упаковки онигири с лентой', ro: 'Folie ambalat onigiri cu bandă', de: 'Dreieckige Onigiri-Verpackungsfolie', fr: 'Film d’emballage onigiri triangle', ar: 'أغلفة الأرز المثلث أونيجيري' } },
      ...
      { icon: '🧂', img: './assets/images/claude_verified_v22/cat_9/prod_1.jpg', name: { en: 'Wasabi & Ginger Portion Sauce Dishes', ru: 'Соусники для васаби и имбиря', ro: 'Caserole mici pentru wasabi și ghimbir', de: 'Portionsschälchen für Wasabi & Ingwer', fr: 'Ramequins pour wasabi & gingembre', ar: 'عبوات صغيرة للواسابي والزنجبيل' } },
      { icon: '🥢', img: './assets/images/claude_verified_v22/cat_9/prod_2.jpg', name: { en: 'Chopstick Rest Holders & Wooden Trays', ru: 'Подставки для палочек и деревянные подносы', ro: 'Suporturi bețișoare și tăvi din lemn', de: 'Essstäbchen-Bänke & Holz-Trays', fr: 'Repose-baguettes & plateaux en bois', ar: 'مساند خشبية لعيدان الأكل والصواني' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🌱',
    img: './assets/images/claude_verified_v22/cat_10/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '🌾', img: './assets/images/claude_verified_v22/cat_10/prod_5.jpg', name: { en: 'PLA Bio Barrier Stretch Shrink Film', ru: 'Биоразлагаемая стретч-пленка PLA', ro: 'Folie barieră stretch biodegradabilă PLA', de: 'PLA Bio-Dehn- & Schrumpffolie', fr: 'Film étirable & rétractable bio PLA', ar: 'رول استرتش حيوي عازل قابل للتحلل' } },
      ...
      { icon: '🥖', img: './assets/images/claude_verified_v22/cat_10/prod_3.jpg', name: { en: 'Bio Bread & Bakery Bags with Window', ru: 'Био-пакеты для хлеба с окошком', ro: 'Pungi bio pentru pâine cu fereastră', de: 'Bio-Brotbeutel mit Sichtfenster', fr: 'Sacs à pain bio avec fenêtre', ar: 'أكياس خبز عضوية قابلة للتحلل مع نافذة' } },
      ...
      { icon: '📦', img: './assets/images/claude_verified_v22/cat_10/prod_5.jpg', name: { en: 'PBAT Eco Bubble Wrap Protective Roll', ru: 'Биоразлагаемая воздушно-пузырьковая пленка', ro: 'Folie cu bule biodegradabilă PBAT', de: 'Biologisch abbaubare Luftpolsterfolie PBAT', fr: 'Film à bulles biodégradable PBAT', ar: 'رولفقاعات حماية حيوية PBAT' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '🛍️',
    img: './assets/images/claude_verified_v22/cat_11/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🛍️', img: './assets/images/claude_verified_v22/cat_11/prod_1.jpg', name: { en: 'Non-Woven Spunbond Shopping Bags 80gsm', ru: 'Сумки из спанбонда 80г/м² с логотипом', ro: 'Sacoșe nețesute Spunbond 80gsm cu logo', de: 'Vliesstoff-Einkaufstaschen 80g/m²', fr: 'Sacs cabas non-tissé Spunbond 80g/m²', ar: 'حقائب سبانبود القماشية الدعائية 80 جرام' } },
      { icon: '⚡', img: './assets/images/claude_verified_v22/cat_11/prod_2.jpg', name: { en: 'Ultrasonic Heat Sealed Non-Woven Bags', ru: 'Сумки из спанбонда ультразвуковой пайкой', ro: 'Sacoșe nețesute lipite cu ultrasunete', de: 'Ultraschall-verschweißte Vliesstofftaschen', fr: 'Sacs non-tissé thermosoudés ultrasons', ar: 'حقائب سبانبود ملحومة بالحرارة فوق الصوتية' } },
      { icon: '👜', img: './assets/images/claude_verified_v22/cat_11/prod_3.jpg', name: { en: 'Organic Cotton Canvas Shopper Bags 140gsm', ru: 'Эко-сумки из хлопка 140г/м²', ro: 'Sacoșe din bumbac organic 140gsm', de: 'Bio-Baumwoll-Canvas-Taschen 140g/m²', fr: 'Sacs cabas en coton bio 140g/m²', ar: 'حقائب تسوق قطنية 140 جرام' } },
      { icon: '💼', img: './assets/images/claude_verified_v22/cat_11/prod_4.jpg', name: { en: 'Heavy Duty Cotton Canvas Grocery Totes 280gsm', ru: 'Плотные сумки из холста 280г/м²', ro: 'Sacoșe groase din pânză bumbac 280gsm', de: 'Starke Baumwoll-Canvas-Shopper 280g/m²', fr: 'Sacs cabas épais en toile coton 280g/m²', ar: 'حقائب قماشية سميكة للأوزان 280 جرام' } },
      { icon: '✨', img: './assets/images/claude_verified_v22/cat_11/prod_5.jpg', name: { en: 'Gloss Laminated Woven Promo Shoppers', ru: 'Ламинированные глянцевые промо-сумки', ro: 'Sacoșe promoționale laminate lucioase', de: 'Laminierte Glanz-Werbeshopper', fr: 'Sacs cabas publicitaires laminés brillants', ar: 'حقائب تسوق لامعة مطبوعة بحجم كبير' } },
      { icon: '🖤', img: './assets/images/claude_verified_v22/cat_11/prod_6.jpg', name: { en: 'Matte Laminated Non-Woven Event Bags', ru: 'Матовые ламинированные промо-сумки', ro: 'Sacoșe promoționale laminate mate', de: 'Laminierte Matt-Werbeshopper', fr: 'Sacs cabas publicitaires laminés mats', ar: 'حقائب مطبوعة بطبقة مات عازلة' } },
      { icon: '🎒', img: './assets/images/claude_verified_v22/cat_11/prod_1.jpg', name: { en: 'Drawstring Polyester Backpack Bags for Events', ru: 'Сумки-рюкзаки на затяжках для мероприятий', ro: 'Saci rucsac cu șnur pentru evenimente', de: 'Zugband-Rucksacktaschen für Events', fr: 'Sacs à dos à cordon pour événements', ar: 'حقائب ظهر برباط للمؤتمرات والفعاليات' } },
      { icon: '🔄', img: './assets/images/claude_verified_v22/cat_11/prod_2.jpg', name: { en: 'Foldable Compact Nylon Shopping Pouches', ru: 'Складные нейлоновые сумки для покупок', ro: 'Sacoșe pliabile din nailon', de: 'Faltbare Nylon-Einkaufstaschen', fr: 'Sacs de shopping pliables en nylon', ar: 'حقائب تسوق من النايلون قابلة للطي' } },
      { icon: '🌿', img: './assets/images/claude_verified_v22/cat_11/prod_3.jpg', name: { en: 'Jute & Burlap Natural Shopping Tote Bags', ru: 'Сумки для покупок из джута и мешковины', ro: 'Sacoșe din iută naturală', de: 'Natürliche Jute- & Sackleinen-Shopper', fr: 'Sacs cabas en jute naturelle', ar: 'حقائب تسوق من قماش الخيش والجوث الطبيعي' } },
      { icon: '♻️', img: './assets/images/claude_verified_v22/cat_11/prod_4.jpg', name: { en: 'RPET Recycled Plastic Bottle Promo Shoppers', ru: 'Промо-сумки из переработанных пластиковых бутылок RPET', ro: 'Sacoșe promo din sticle plastic reciclate RPET', de: 'RPET Recycling-Plastikflaschen-Werbetaschen', fr: 'Sacs publicitaires en bouteilles plastique recyclées RPET', ar: 'حقائب تسوق مصنوعة من البلاستيك المعاد تدويره RPET' } }
    ]
  },

  {
    ...
    group: 'packaging',
    icon: '📦',
    img: './assets/images/claude_verified_v22/cat_12/header.jpg',
    chip: {
...

  {
    ...
    group: 'hotel',
    icon: '🩴',
    img: './assets/images/claude_verified_v22/cat_13/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '🧽', img: './assets/images/claude_verified_v22/cat_13/prod_2.jpg', name: { en: 'Shoe Shine Polishing Mitts & Cloths', ru: 'Варежки и салфетки для полировки обуви', ro: 'Mănuși și lavete lustruit pantofi', de: 'Schuhputz-Handschuhe & Poliertücher', fr: 'Gants & chiffons à polir les chaussures', ar: 'قُفازات ومناشف تلميع الأحذية' } },
      ...
      { icon: '👔', img: './assets/images/claude_verified_v22/cat_13/prod_4.jpg', name: { en: 'Velvet Anti-Slip Clothes Hangers with Clips', ru: 'Велюровые вешалки для одежды с зажимами', ro: 'Umerașe catifea antiderapante cu cleme', de: 'Samt Kleiderbügel anti-rutsch mit Klammern', fr: 'Cintres velours antidérapants avec pinces', ar: 'علاقات ملابس مخملية مع مشابك' } },
      { icon: '👔', img: './assets/images/claude_verified_v22/cat_13/prod_1.jpg', name: { en: 'Solid Wooden Hotel Suit & Coat Hangers', ru: 'Деревянные вешалки для костюмов и пальто', ro: 'Umerașe din lemn masiv pentru costume', de: 'Massivholz-Hotelbügel für Anzüge', fr: 'Cintres en bois massif pour costumes', ar: 'علاقات ملابس خشبية صلبة للبدل' } },
      { icon: '🚪', img: './assets/images/claude_verified_v22/cat_13/prod_2.jpg', name: { en: 'Hotel Room Do Not Disturb Door Hangers', ru: 'Таблички на дверь «Не беспокоить»', ro: 'Agățătoare ușă «Nu deranjați»', de: 'Türhänger «Bitte nicht stören»', fr: 'Accroche-portes «Ne pas déranger»', ar: 'بطاقات تعليق الأبواب رجاء عدم الإزعاج' } }
    ]
  },

  {
    ...
    group: 'hotel',
    icon: '🧴',
    img: './assets/images/claude_verified_v22/cat_14/header.jpg',
    chip: {
    ...
    products: [
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: '30ml Hotel Nourishing Shampoo Bottles', ru: 'Мини-флаконы питательного шампуня 30мл', ro: 'Flacoane 30ml șampon hrănitor hotel', de: '30ml Pflegeshampoo Fläschchen', fr: 'Flacons 30ml shampooing nourrissant', ar: 'عبوات شامبو المغذي 30 مل للفنادق' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: '30ml Refreshing Shower Gel Bottles', ru: 'Гель для душа освежающий 30мл', ro: 'Gel de duș revigorant 30ml', de: '30ml Duschgel Fläschchen', fr: 'Flacons 30ml gel douche rafraîchissant', ar: 'عبوات جل الاستحمام 30 مل للفنادق' } },
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: '30ml Hair Conditioner Bottles', ru: 'Кондиционер для волос 30мл', ro: 'Balsam de păr 30ml', de: '30ml Haarconditioner Fläschchen', fr: 'Flacons 30ml après-shampooing', ar: 'عبوات بلسم الشعر 30 مل' } },
      { icon: '🧴', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: '30ml Moisturizing Body Lotion Bottles', ru: 'Увлажняющий лосьон для тела 30мл', ro: 'Loțiune hidratantă corp 30ml', de: '30ml Feuchtigkeits-Bodylotion', fr: 'Flacons 30ml lait hydratant corps', ar: 'عبوات لوشن مرطب للجسم 30 مل' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: 'Pleated Paper Wrapped Soaps 20g', ru: 'Мыло в плиссе 20г с логотипом', ro: 'Săpun ambalat în hârtie pliabilă 20g', de: 'Plissierte Seifen 20g mit Logo', fr: 'Savons plissés 20g avec logo', ar: 'صابون مغلف ورق مطوي 20 جرام' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: 'Boxed Square Transparent Glycerin Soaps 25g', ru: 'Глицериновое прозрачное мыло в коробке 25г', ro: 'Săpun transparent din glicerină 25g', de: 'Glycerin-Seifen im Karton 25g', fr: 'Savons à la glycérine en boîte 25g', ar: 'صابون جليسرين شفاف مربع في كرتون 25 جرام' } },
      ...
      { icon: '🪒', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: 'Eco Shaving Kits (Razor + Shaving Cream Tube)', ru: 'Бритвенные наборы с станком и кремом', ro: 'Truse bărbierit (aparat + tub cremă)', de: 'Rasier-Sets (Rasierer + Creme-Tube)', fr: 'Kits de rasage (rasoir + tube crème)', ar: 'أطقم الحلاقة (ماكينة حلاقة مع أنبوب كريم)' } },
      ...
      { icon: '🚿', img: './assets/images/claude_verified_v22/cat_14/prod_1.jpg', name: { en: 'Waterproof Shower Caps in Paper Box', ru: 'Шапочки для душа в бумажной коробке', ro: 'Scufii duș impermeabile în cutie carton', de: 'Duschhauben in Pappschachtel', fr: 'Charlottes de douche en boîte papier', ar: 'قبعات الاستحمام المعقمة في علب' } },
...

  {
    ...
    group: 'hotel',
    icon: '🧳',
    img: './assets/images/claude_verified_v22/cat_15/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '💨', img: './assets/images/claude_verified_v22/cat_15/prod_2.jpg', name: { en: 'Hotel Wall Mounted Hair Dryers 1600W', ru: 'Настенные фены для отелей 1600 Вт', ro: 'Uscătoare de păr perete hotel 1600W', de: 'Hotel-Wandhaartrockner 1600W', fr: 'Sèche-cheveux muraux d’hôtel 1600W', ar: 'مجففات شعر جدارية للفنادق 1600 واط' } },
      { icon: '🗑️', img: './assets/images/claude_verified_v22/cat_15/prod_3.png', name: { en: 'Stainless Steel Trash Bins with Pedal', ru: 'Урновые мусорные ведра из нержавейки с педалью', ro: 'Coșuri gunoi inox cu pedală', de: 'Edelstahl-Abfalleimer mit Pedal', fr: 'Poubelles à pédale en inox', ar: 'سلال نفايات ستانلس ستيل بدواسة' } },
...

  {
    ...
    group: 'hotel',
    icon: '🍽️',
    img: './assets/images/claude_verified_v22/cat_16/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '🍴', img: './assets/images/claude_verified_v22/cat_16/header.jpg', name: { en: 'Stainless Steel Cutlery & Utensil Holders', ru: 'Подставки для столовых приборов из нержавейки', ro: 'Suporturi tacâmuri din inox', de: 'Edelstahl-Besteckhalter & Behälter', fr: 'Porte-couverts & ustensiles en inox', ar: 'حوامل وحافظات أطقم أدوات المائدة' } },
...

  {
    ...
    group: 'hotel',
    icon: '🏊',
    img: './assets/images/claude_verified_v22/cat_17/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '🪣', img: './assets/images/claude_verified_v22/cat_17/prod_1.jpg', name: { en: 'Wooden Sauna Buckets & Ladles Set', ru: 'Деревянные ушаты и черпаки для сауны', ro: 'Set găleți și linguri din lemn saună', de: 'Holz-Saunaeimer & Kellen-Set', fr: 'Kits seaux & louches en bois pour sauna', ar: 'أطقم دلاء ومغارف خشبية لغرف الساونا' } },
      ...
      { icon: '👘', img: './assets/images/claude_verified_v22/cat_17/prod_1.jpg', name: { en: 'Luxury Velour SPA Kimono Robes', ru: 'Элитные велюровые халаты-кимоно для SPA', ro: 'Halate baie kimono din pluș pentru SPA', de: 'Luxus-Velours-SPA-Kimonomäntel', fr: 'Peignoirs kimono en velours de luxe SPA', ar: 'أرواب سبا فاخرة بقصة الكيمونو' } },
      { icon: '🧖', img: './assets/images/claude_verified_v22/cat_17/prod_1.jpg', name: { en: 'Terry Waffle SPA Wraps & Hair Turbans', ru: 'Вафельные накидки и тюрбаны для волос SPA', ro: 'Prosoape baie tip wrap și turbane păr SPA', de: 'Waffel-SPA-Wraps & Haarturbane', fr: 'Peignoirs wraps & turbans cheveux SPA', ar: 'مناشف ولفافات شعر وتوربان للسبا' } },
...

  {
    ...
    group: 'hotel',
    icon: '🛏️',
    img: './assets/images/claude_verified_v22/cat_18/header.jpg',
    chip: {
    ...
    products: [
      ...
      { icon: '💤', img: './assets/images/claude_verified_v22/cat_18/prod_1.jpg', name: { en: 'Hotel Pillowcases (Satin Stripe / Plain)', ru: 'Наволочки для гостиниц (страйп-сатин и гладкие)', ro: 'Fețe de pernă hotel (satin cu dungi și simplu)', de: 'Hotel-Kissenbezüge (Streifensatin & Glatt)', fr: 'Taies d’oreiller hôtel (satin rayé & uni)', ar: 'أغطية وسائد للفنادق (ساتان مقلم وسادة)' } },
      { icon: '🛀', img: './assets/images/claude_verified_v22/cat_18/prod_1.jpg', name: { en: 'Heavy Commercial Bath Towels 600 GSM', ru: 'Плотные банные полотенца 600 г/м²', ro: 'Prosoape baie dense 600 GSM', de: 'Schwere Gewerbe-Handtücher 600 GSM', fr: 'Draps de bain denses 600 GSM', ar: 'مناشف حمام ثقيلة وممتازة 600 جرام' } },
      { icon: '🧼', img: './assets/images/claude_verified_v22/cat_18/prod_1.jpg', name: { en: 'Hotel Hand Towels & Face Washcloths', ru: 'Полотенца для рук и салфетки для лица', ro: 'Prosoape mâini și fețe de masă hotel', de: 'Hotel Handtücher & Gesichtstücher', fr: 'Serviettes mains & débarbouillettes hôtel', ar: 'مناشف أيدي ومناشف وجة صغيرة للفنادق' } },
      { icon: '🦶', img: './assets/images/claude_verified_v22/cat_18/prod_1.jpg', name: { en: 'Hotel Bath Mats 800 GSM Heavy Terry', ru: 'Коврики для ног в ванную 800 г/м²', ro: 'Covorașe baie din bumbac 800 GSM', de: 'Hotel Duschvorleger 800 GSM', fr: 'Tapis de bain denses 800 GSM', ar: 'دواسات ومفارش حمام ثقيلة 800 جرام' } },
      ...
      { icon: '🥋', img: './assets/images/claude_verified_v22/cat_18/prod_1.jpg', name: { en: 'Waffle Weave Lightweight Hotel Bathrobes', ru: 'Вафельные легкие халаты для отелей', ro: 'Halate baie ușoare din bumbac waffle', de: 'Leichte Waffel-Bademäntel für Hotels', fr: 'Peignoirs de bain légers gaufres', ar: 'أرواب حمام قطن مجعد خفيفة للفنادق' } },
...

  {
    ...
    group: 'perfume',
    icon: '🧴',
    img: './assets/images/claude_verified_v22/cat_19/header.svg',
    chip: {
