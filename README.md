# WOPPAG KRAFT & FOODS — Ultra-Modern B2B Wholesale Platform

Official repository for **WOPPAG KRAFT & FOODS** (`woppag.com`), a global factory-direct B2B wholesale platform for packaging, portioning, perfume glass bottles, and hotel equipment.
...
```
.
├── index.html              # Main Single-Page Application & Structured Data
├── CNAME                   # Custom domain declaration (woppag.com)
└── assets/
    ├── css/
    │   └── style.css       # Metallic Gold & Navy Glassmorphism Stylesheet
    ├── js/
    │   ├── data.js         # 20 Categories & 238+ Sub-Products Dataset
    │   ├── i18n.js         # 6-Language Internationalization Engine
    │   └── app.js          # Main Application Controller & Form Handlers
    └── images/             # Authentic Local Product Image Assets
```

## 🚀 Deployment Instructions

### GitHub Pages (Custom Domain `woppag.com`)
1. Go to **Repository Settings** -> **Pages**.
2. Select Source: `Deploy from a branch` -> `main` / `root`.
3. Under Custom Domain, enter `woppag.com` and enable **Enforce HTTPS**.

---
© 2026 WOPPAG KRAFT & FOODS. All Rights Reserved.
